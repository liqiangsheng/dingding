        ...
        <div class="yuyue">
          ...
          <ul>
            ...
            <li id="shijian">　预约时间<span>*</span>
              ...
              <DatePicker type="date" v-model="input5" :options="options3" @blur.native.capture="input5Blur()" placeholder="请选择预约日期" :style="timeStyle"
      ...
      input1:function(new1,old1){
        if(new1 != ""){
          ...
          if(res2.test(new1) == false ){
            this.inputOne = " 请填写联系人，长度不超过20字符，不可输入特殊符号数字"
          }else{
            this.inputOne = ""
          }
        }
