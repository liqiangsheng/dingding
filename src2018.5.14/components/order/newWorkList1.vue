<template>
  ...
  <div>
    <div class="yuyue">
      ...
      <ul>
        <li>　　联系人<span>*</span><el-input v-model="input1" placeholder="请输入联系人" style="width: 25%"></el-input></li>
        <li>联系人手机<span>*</span><el-input v-model="input2" placeholder="请输入正确手机号码" style="width: 25%"></el-input> 　　　<b style="font-weight:100; margin: 0 20px">座机</b><el-input v-model="input6" placeholder="请输入正确座机（非必填）" style="width: 20%"></el-input></li>
        ...
        <li>　详细地址<span>*</span><el-input v-model="input4" placeholder="请填写详细地址" style="width: 25%"></el-input></li>
        <li id="shijian">　预约时间<span>*</span>
          ...
          <DatePicker type="datetime" v-model="input5" format="yyyy-MM-dd HH:mm:ss" placeholder="请选择预约日期" style="width: 24.6%;height: 36px"></DatePicker><!--</Col>-->
        </li>
