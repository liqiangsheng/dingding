<template>
  ...
  <div>
    ...
    <div class="creditIsRunningLow_box">
      ...
      <div class="center">
        <p>新密码<el-input v-model="password1" placeholder="请输入新密码"></el-input></p>
        <p>再次输入新密码<el-input v-model="password2" placeholder="请再次输入新密码"></el-input></p>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      Okclick(){
        ...
        this.$http.post(urlR,o).then(res=>{
