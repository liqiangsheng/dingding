      ...
      <div class="scrollbar content">
        ...
        <section class="container_content">
            <aside class="container_content_left">
              <div v-for="(item,index) in inputs" :key="index" v-show="index<5">
                <inputs-list :inputs="inputs" :item="item" v-if="isInput(isEdit,item.isEdit)"></inputs-list>
          ...
          <aside class="container_content_right">
            <div v-for="(item,index) in inputs" :key="index" v-show="index>4">
              <inputs-list :inputs="inputs" :item="item" v-if="isEdit"></inputs-list>
