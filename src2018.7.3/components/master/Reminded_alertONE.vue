        ...
        <div class="left_info">
          ...
          <ul v-if="isAdd" class="add_reminded">
            <li v-for="(item,index) in optionList" :key="index">
              ...
              <span v-show="item.isBool" style="color: red">{{item.isBool}}</span>
            </li>
            <li id="listName">
              ...
              <el-cascader ref="fuwugongzhong" id="labelId" style="width: 260px;margin-left: 14px;height: 40px"
                           ...
                           :props="props1"
              ></el-cascader>
              <span v-show="skillsOne" style="color: red">{{skillsOne}}</span>
            </li>
          </ul>
          <ul v-else>
        ...
        <div class="right_info">
          ...
          <ul>
            ...
            <li v-for="(item,index) in RemindedList" :key="index">
              ...
              <span style="color: red" v-show="item.isBool">{{item.isBool}}</span>
            </li>
            <li>
              <span class="list_name"> {{Reminded[0].name | placeholder}}</span>
              <el-input-number v-model="number" :min="1" :max="100"
                               style="width: 260px;margin-left: 14px;height: 40px"></el-input-number>
              <span style="color: red" v-show="Reminded[0].isBool">{{Reminded[0].isBool}}</span>
            ...
            <li>
              ...
              <span v-show="Reminded[0].isBool1" style="color:red">{{Reminded[0].isBool1}}</span>
            </li>
          </ul>
        </div>
      </div>
