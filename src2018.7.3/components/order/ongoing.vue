      ...
      <div class="dable_lsit" >
        ...
        <table cellSpacing="0px" cellpadding="0"  id="table">
          ...
          <tr v-for="(item,index) in tableListData.orders" :class="[{activeOrder:item.styleShow==true},{ trActive:item.borderShow == true}]" >
            ...
            <!--工单号-->
            <td @click="orderDetails(item,item.id,index)" id="orderId" style="word-break: break-all;">
        ...
        optionList: [       //下拉列表数据
          {
            ...
            SourceType:[{value:"网点待分配",id:"04"},{value:"待上工",id:"05"},{value:"待抵达",id:"06"},{value:"待分配",id:"03"},{value:"服务中",id:"07"},{value:"待核账",id:"10"},{value:"待付尾款",id:"11"},{value:"待退款",id:"13"}]
          }
        ],
