        ...
        <div class="left_info">
          ...
          ></el-cascader>
            ...
            <li>开户行:
              ...
              <span v-else>
                <el-select style="margin-left: 44px" v-model.trim="dataObj.bankOfDeposit" placeholder="请选择"
            ...
            <li>账单日:
              ...
              <span v-else>
                 <el-select v-model.trim="dataObj.settleDay" placeholder="请选择">
                <el-option
            ...
            <div class="dable_lsit" v-show="subsetInfos.length>0">
              ...
              <table cellSpacing="0px" cellpadding="0">
                ...
                <tr v-for="(item,index) in subsetInfos">
                  <td>
                    {{item.city}}
                    <input type="text" v-model.trim="item.link" class="copy_input" ref="link">
                  </td>
                  <td>
                    {{item.name}}
                  </td>
