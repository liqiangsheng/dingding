  ...
  <el-card class="box-card">
    <el-form ref="chargeForm" :model="chargeForm" label-width="80px">
      <el-form-item label="城市">
        <el-select
          v-model.trim="city.SourceTypeValue" :placeholder="selectorBehindObj.area"
      ...
      <el-form-item label="高空层">
        <el-input v-model.trim="selectorBehindObj.floorStart" type="number" style="width:30%"></el-input> &nbsp;-&nbsp;
        <el-input v-model.trim="selectorBehindObj.floorEnd" type="number" style="width:30%"></el-input>
      </el-form-item>
      <el-form-item label="费用">
        <el-input v-model.trim="selectorBehindObj.price" type="number"></el-input>
      </el-form-item>
      <el-form-item>
