  ...
  <el-card class="box-card">
    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="上级分类">
        <el-select v-model.trim="value" placeholder="请选择" @change="prevClassName">
      ...
      <el-form-item label="末级分类">
        <el-radio-group v-model.trim="form.last">
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        let lastBoole=this.form.last;
        let name=this.form.name;
        let prevClassNameId=this.prevClassNameId;
