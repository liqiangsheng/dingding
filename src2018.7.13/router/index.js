...
console.log(window.common.siteAppDomain,'211')
...
const OrderList11 = resolve => require(['@/components/order/sparePartsWaiting'], resolve);//配件等待
      ...
      // },
        ...
        },
        {
            ...
            children: [
                    ...
                    { path: '/order/list4',component: OrderList4,name: '异常挂起工单',menuShow: isShowFunObj.isUserNavChild("sn-order-pending")},
                    { path: '/order/sparePartsWaiting', component: OrderList11, name: '配件等待', menuShow:true },
