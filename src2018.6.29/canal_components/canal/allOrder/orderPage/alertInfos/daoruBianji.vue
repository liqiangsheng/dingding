        ...
        <ul class="center">
          <div class="fuwuxinxi">
            <ul class="list" id="addAlertList">
              ...
              <li>　　　　分类<span>*</span>
                <el-select v-model.trim="fenlei" placeholder="请选择" style="width: 80%;margin-left: 20px;"
                           @change="yijifenlei2">
                  <el-option
              ...
              <li>　　　　品牌
                <el-input v-model.trim="input1" placeholder="选填" style="width: 35%;margin:0 20px 0 30px;"></el-input>
                型号
                <el-input v-model.trim="input2" placeholder="选填" style="width: 35%;margin-left: 20px;"></el-input>
              </li>
              <li id="nunber1">　　　　数量<span>*</span>
                <el-input-number style="margin-left: 20px;" v-model.trim="num" @change="handleChange"
            ...
            <ul class="yuyuexinxi">
              ...
              <li>　　联系人<span>*</span>
                <el-input v-model.trim="input7" placeholder="请填写内容" style="width: 80%;"></el-input>
              </li>
              <li>联系人手机<span>*</span>
                <el-input v-model.trim="input8" placeholder="请填写内容" style="width: 35%"></el-input>
                　　　<b style="font-weight:100; margin: 0 20px">座机</b>
                <el-input v-model.trim="input6" placeholder="请填写内容" style="width: 34%"></el-input>
              </li>
              ...
              <li>　详细地址<span>*</span>
                <el-input v-model.trim="input4" placeholder="请填写内容" style="width: 80%"></el-input>
              </li>
              <li id="shijian">　预约时间<span>*</span>
                <!--<Col span="12" style="display: inline-block">-->
                <!--<DatePicker type="date" placeholder="请选择日期" style="width: 24.6%;height: 36px" v-model.trim="input5"></DatePicker>-->
                <DatePicker type="datetime" v-model.trim="input5" format="yyyy-MM-dd HH:mm:ss" placeholder="请选择日期"
                            style="width: 24.6%;height: 36px"></DatePicker><!--</Col>-->
              </li>
            ...
            <div class="ziqudao">
              <p class="ziqudaoP">　　子渠道
                <el-select v-model.trim="value" placeholder="请选择" @change="ziqudaoA(value)" style="width: 80%">
                  <el-option
