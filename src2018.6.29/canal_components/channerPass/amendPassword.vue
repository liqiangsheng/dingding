      ...
      <el-dialog style="z-index:9999999999;"  :visible.sync="$store.state.isChannelPassword" size="min">
        <ul class="alert_forbidden_text">
          <li>
            <div class="list_name">
             ...
             <form class="form" action="">
               <el-input style="width:250px;" v-model.trim="newPass" autocomplet="off" placeholder="请填写新密码"
          ...
          <li>
            ...
            <form class="form" action="">
              <el-input style="width:250px;" v-model.trim="affirmPas" placeholder="请确认密码" type="password"></el-input>
            </form>
        ...
        methods: {
          submit(){
            if(!this.affirmPas || !this.newPass){
              this.$queryFun.successAlert.call(this,"请填写密码...","0");
