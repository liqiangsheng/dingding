...
<template>
  <div id="app">
    <div class="container">
      <!--<h3>工单跟踪</h3>--> <p class="closeX" id="closeX" @click="close"></p>
      <div class="content">
