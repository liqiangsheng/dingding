         ...
         <div class="biaoqian_box">
                <div class="biaoqian_boxTop">打标签
                 ...
                 <div class="biaoqian_number">
                   <ul>
                     <li v-for="(item,index) in biaoqianArray"><span @click="spanClick(item,index)"
                       ...
                       <input maxlength=15   minlength=1   type="text" v-model.trim="item.name"
                              @blur.prevent="blurClick(item,index)"/>
                 ...
                 <div class="biaoqian_center">
                   <el-input type="text" placeholder="请填写标签名字" v-model.trim="biaoqianName"
                             style="width:15%; margin:2% 2% 1% 2%; height: 38%;"></el-input>
           ...
           if(this.biaoqianName === ""){
               ...
               this.$http.post(url,objParms).then((res)=>{
                   if(res.data.code === "0000"){
                           this.$queryFun.successAlert.call(this,"标签添加成功","1")
                            this.chushihua();
                   }else{
                             this.biaoqianName = "";
