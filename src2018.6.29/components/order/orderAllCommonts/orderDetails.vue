<template>
  <div id="app">
    <!--悬浮按钮-->
    <!--<div class="headerBtn" style="position: fixed;z-index: 9999">-->
    <div class="headerBtn">
      <div>
      ...
      <div>
        <p class="cursor">异常挂起</p>
        <p class="cursor">改派</p>
        <p class="cursor">新增产品</p>
        <p class="cursor">备注</p>
        <p class="cursor">投诉工单</p>
        <p class="cursor">取消订单</p>
        <p class="cursor">催单</p>
        <p class="cursor">罚款师傅</p>
      </div>
    </div>
    <!--列表信息-->
    <div class="tableList">
...
//            '优惠金额',
    ...
    created(){
      console.log(this.orderDetailed,"88888")
      this.findOne();
      this.getTableList();
    },
    computed:{
    ...
    methods: {
      ...
      openImage(e){
        ...
        console.log(this.imagesData,'2342342')
      },
      getAddress(){
