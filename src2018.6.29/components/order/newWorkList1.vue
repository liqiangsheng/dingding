<template>
  ...
  <div>
    <div class="yuyue">
      ...
      <ul>
        <li>　　联系人<span>*</span>
          <el-input v-model.trim="input1" placeholder="请填写联系人" style="width: 25%"></el-input>
        </li>
        <li>联系人手机<span>*</span>
          <el-input v-model.trim="input2" placeholder="请填写正确手机号码" style="width: 25%"></el-input>
          　　　<b style="font-weight:100; margin: 0 20px">座机</b>
          <el-input v-model.trim="input6" placeholder="请填写正确座机（非必填）" style="width: 20%"></el-input>
        </li>
        ...
        <li>　详细地址<span>*</span>
          <el-input v-model.trim="input4" placeholder="请填写详细地址" style="width: 25%"></el-input>
        </li>
        <li id="shijian">　预约时间<span>*</span>
          ...
          <DatePicker type="datetime" v-model.trim="input5" format="yyyy-MM-dd HH:mm:ss" placeholder="请选择预约日期"
...
<script>
  ...
  export default {
    components:{
      AddAlter,BianjiAlter,CreditIsRunningLow
    },
    data() {
      return {
        //区域start
    ...
    methods: {
      ...
      ifElse(){  //
        if(this.input1 == ""){
          this.flag = false;
          this.$queryFun.successAlert.call(this,"请填写联系人姓名")
          return setTimeout(()=>{
            location.reload();
          },1000)
        ...
        if(this.input2 == ""){
          this.flag = false;
           this.$queryFun.successAlert.call(this,"请填写联系人手机号");
          return setTimeout(()=>{
            location.reload();
          },1000)
        }
        ...
        if(reg.test(this.input2)==false){
          this.flag = false;
        this.$queryFun.successAlert.call(this,"请填写正确手机号，长度为11位数字");
          return setTimeout(()=>{
            location.reload();
          },1000)
        ...
        if(this.selectedOptions2.length<=0||this.selectedOptions1.length<=0){
          this.flag = false;
          this.$queryFun.successAlert.call(this,"请选择城市，街道");
          return setTimeout(()=>{
            location.reload();
          },1000)
        }
        ...
        if(this.input5 == ""){
          ...
          this.flag = false;
          this.$queryFun.successAlert.call(this,"请选择预约时间");
          return setTimeout(()=>{
            location.reload();
          },1000)
        }
      ...
      addTijiao(){ //提交
        ...
        if(this.peijiankuang == false){
          this.flag = false;
           this.$queryFun.successAlert.call(this,"请选择服务产品")
          return setTimeout(()=>{
            location.reload();
          },1000)
        }
