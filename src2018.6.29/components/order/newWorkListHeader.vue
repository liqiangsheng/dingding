      ...
      <div>
        <div class="yuyue">
          ...
          <ul>
            ...
            <li>　详细地址<span>*</span>
              <el-input v-model="input4" placeholder="请填写详细地址" style="width: 200px"></el-input>
...
//城市
    ...
    methods: {
      ...
      addOK() {//确定添加
        if (this.input1 == "") {
          this.inputOne = "请填写联系人姓名"
          return this.$queryFun.successAlert.call(this, "请填写联系人姓名")
        }else{
          this.inputOne = ""
        }
        ...
        if (this.input2 == "") {
          this.inputTwo = "请填写联系人手机号"
          return this.$queryFun.successAlert.call(this, "请填写联系人手机号");
        }else{
          this.inputTwo = "";
        }
        let reg = /^1\d{10}$/;
        if (reg.test(this.input2) == false) {
          this.inputTwo = "请填写正确手机号，长度为11位数字"
          return this.$queryFun.successAlert.call(this, "请填写正确手机号，长度为11位数字");
        }else{
          this.inputTwo = ""
        }
        ...
        if (this.input5 == "") {
          this.inputFive= "请选择预约时间";
          return this.$queryFun.successAlert.call(this, "请选择预约时间");
        }else{
          this.inputFive= "";
        }
        if (this.timeOptions == "") {
          this.timeOptionOne ="请选择预约时间段"
          return this.$queryFun.successAlert.call(this, "请选择预约时间段");
        }else{
          this.timeOptionOne =""
        }
...
//        this.$store.dispatch("cityIdid",this.cityId)
      ...
      addTijiao() { //提交
        ...
        if (this.peijiankuang == false) {
          this.peijiankuangOne = "请选择服务产品";
          return this.$queryFun.successAlert.call(this, "请选择服务产品");
        }else{
          this.peijiankuangOne = "";
        }
      ...
      getTableList(params) {
        ...
        this.$http.post(url, params).then(res => {
          if (res.data.code == "0000") {
            ...
            this.reload();
            this.$store.commit("spliceTabByPath","/order/list2")
