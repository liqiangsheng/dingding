...
<div id="app">
      <div class="container">
        ...
        <!--<vue-editor v-model.trim="content"></vue-editor>-->
        <!--<UEditor :config=config  ref="ueditor" style="width: 100%;height:500px;"  v-model.trim="content"></UEditor>-->
        <Ueditor :config=config ref="ueditor" style="width: 100%;height:500px;" v-model.trim="content">
        </Ueditor>
      </div>
          <div class="btn">
