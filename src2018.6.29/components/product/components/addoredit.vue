  ...
  <div id="app">
    ...
    <div class="container">
      ...
      <div class="selector_list">
        ...
        <div class="list">
          分类:
          <el-select v-model.trim="category" placeholder="请选择">
            <el-option
        ...
        <div class="list">
          商品类型:
          <el-select v-model.trim="productType" placeholder="请选择">
            <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
        ...
        <div class="list">
          显示高空费 :
          <el-radio-group v-model.trim="radio2">
      ...
      <div class="dable_lsit" v-if="showflag">
        ...
        <table cellSpacing="0px" cellpadding="0">
          ...
          <tbody>
          <tr v-for="(item,index) in tableListData1.productInfos">
            <td>
              {{item.number}}
            </td>
            <td>
              <el-input v-model.trim="item.paretsName" placeholder="请填写配件名称"></el-input>
            </td>
            <td>
              <el-input-number v-model.trim="item.price" :min="0"></el-input-number>
            </td>
      ...
      <div class="btn_inquiry" @click="saveProduct">
        保存
      </div>
