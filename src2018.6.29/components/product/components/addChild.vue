  ...
  <div>
    <el-dialog style="z-index:999999"   :visible.sync="data.isShow" size="mini">
      <div class="list">
        ...
        <el-input v-model.trim="selectorBehindObj.name"></el-input>
      </div>
      <div class="list">
        <div class="list_name">
          末级分类 :
        </div>
        <el-radio-group v-model.trim="selectorBehindObj.isEnd">
      ...
      <div class="list" v-show="!selectorBehindObj.isEnd">
        ...
        <el-input v-model.trim="selectorBehindObj.sublevelTitle"></el-input>
      </div>
      <div class="btnBox">
...
<script>
  ...
  export default {
    ...
    methods: {
      preserveSubmit(){
        if(!this.selectorBehindObj.name){return this.$queryFun.successAlert.call(this,"请填写分类名称","0")}else if(!this.selectorBehindObj.isEnd){
          if(!this.selectorBehindObj.sublevelTitle)return this.$queryFun.successAlert.call(this,"请填写子类名称","0");
        };
