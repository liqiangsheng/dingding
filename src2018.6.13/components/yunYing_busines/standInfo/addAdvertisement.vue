        ...
        <div class="left_info">
          <ul>
            <li>
              ...
              <el-select
                v-model.trim="SysMessageType.SourceTypeValue" placeholder="请选择"
            ...
            <li>
              ...
              <el-select
                v-model.trim="receivingType.SourceTypeValue" placeholder="请选择"
            ...
            <li>
              ...
              <el-select
                v-model.trim="receivingObject.SourceTypeValue" placeholder="请选择"
