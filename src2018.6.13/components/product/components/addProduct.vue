<template>
  <div id="app">
    <div class="container">
      ...
      <div class="selector_list">
        <div v-show="isAdd" class="list">
          一级分类 :
          <el-select
            v-model.trim="skillId.SourceTypeValue" placeholder="请选择"
            @change="selector(skillId,skillId.SourceType,skillId.SourceTypeValue)">
            <el-option
        ...
        <div v-show="isAdd" class="list">
          商品类型 :
          <el-select
            v-model.trim="isSecondPayment.SourceTypeValue" placeholder="请选择"
            @change="selector(isSecondPayment,isSecondPayment.SourceType,isSecondPayment.SourceTypeValue)">
            <el-option
        ...
        <div class="list">
          ...
          <el-radio-group style="width:200px;text-align: left;" v-model.trim="selectorBehindObj.isHighFees">
            <el-radio :label="'1'" v-model.trim="selectorBehindObj.isHighFees">是</el-radio>
            <el-radio :label="'0'" v-model.trim="selectorBehindObj.isHighFees">否</el-radio>
          </el-radio-group>
        </div>
        <div class="list">
          ...
          <el-input
            ...
            placeholder="请输入内容"
            v-model.trim="selectorBehindObj.tags">
          </el-input>
        </div>
      </div>
      <!--<div class="dable_lsit">-->
        ...
        <!--<table cellSpacing="0px" cellpadding="0">-->
          ...
          <!--<tr v-for="(item,index) in dataList">-->
            ...
            <!--</td>-->
            <!--<td>-->
      <!--<el-input-number v-model.trim="item.price" :min="0"></el-input-number>-->
            <!--</td>-->
            <!--<td>-->
    ...
    <hsy-dialog class="confirm addService-dialog" v-model.trim="addParetsFlag" :closeButton="false"
