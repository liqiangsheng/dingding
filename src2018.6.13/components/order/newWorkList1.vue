<template>
  ...
  <div>
    <div class="yuyue">
      ...
      <ul>
        <li>　　联系人<span>*</span>
          <el-input v-model.trim="input1" placeholder="请输入联系人" style="width: 25%"></el-input>
        </li>
        <li>联系人手机<span>*</span>
          <el-input v-model.trim="input2" placeholder="请输入正确手机号码" style="width: 25%"></el-input>
          　　　<b style="font-weight:100; margin: 0 20px">座机</b>
          <el-input v-model.trim="input6" placeholder="请输入正确座机（非必填）" style="width: 20%"></el-input>
        </li>
