    ...
    <div class="container">
      ...
      <div class="content">
        <ul class="alert_forbidden_text">
          <li>
            服务数量：
            <el-input v-model.trim="dataObj.serviceSize" placeholder="请输入内容"></el-input>
          </li>
          <li>
            上门费：{{dataObj.price1}}
          </li>
          <li>
            服务费：
            <el-input type="number" v-model.trim="dataObj.price2" placeholder="请输入内容"></el-input>
          </li>
          <li>
            配件费：
            <el-input v-model.trim="dataObj.price3" type="number" placeholder="请输入内容"></el-input>
          </li>
          <li>
            高空费：
            <el-input type="number" v-model.trim="dataObj.price4" placeholder="请输入内容"></el-input>
          </li>
          <li>
