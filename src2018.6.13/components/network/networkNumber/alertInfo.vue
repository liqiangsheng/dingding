          ...
          <ul>
            ...
            <li>
              ...
              <span v-else>
                  <el-input
                    placeholder="请输入内容"
                    v-model.trim="dataObj.linkmanPhoneNum">
                 </el-input>
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <span v-else>
                  <el-input
                    placeholder="请输入内容"
                    v-model.trim="dataObj.companyTel">
                 </el-input>
              </span>
            </li>
            <!--可编辑-->
            ...
            <li>
              ...
              <span v-else>
                <el-select v-model.trim="dataObj.bankOfDeposit" placeholder="请选择"
                           @change="selector4(bank,bank.bankName,dataObj.bankOfDeposit)">
                <el-option
            ...
            <li>
              ...
              <span v-else>
                <el-select
                  style="width:175px;"
                  v-model.trim="area.SourceTypeValue" placeholder="请选择"
                  @change="selector(area,area.SourceType,area.SourceTypeValue)">
                  <el-option
            ...
            <li>
              ...
              <span v-else>
                <el-select
                  style="width:175px;"
                  v-model.trim="skill.SourceTypeValue" placeholder="请选择"
                  @change="selector(skill,skill.SourceType,skill.SourceTypeValue)">
                  <el-option
            ...
            <li >
              <img style="margin-bottom:1em;" v-for="(item,index) in dataObj.imgeas" :src="item" alt="">
            </li>
          </ul>
        </div>
      </div>
  ...
  export default {
    ...
    created(){
      ...
      this.$http.get(url).then(r=>{
        ...
        this.dataObj.imgeas =this.dataObj.idPhotos.split(",");
    ...
    methods: {
      selector4(item,values,bankValue){       //选中银行后的下拉列表
        var key=item.key;
      ...
      open3() {
        this.$prompt('请输入密码', '提示', {
          ...
          this.dataObj.password = md5(value);
        }).catch(() => {
          this.$message({
            type: 'info',
            message: '取消输入'
