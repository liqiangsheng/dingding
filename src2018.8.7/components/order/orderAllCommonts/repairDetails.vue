  ...
  <div id="app" v-cloak @touchmove.prevent>
    ...
    <div class="tableList">
      ...
      <!--<div class="productInfo">-->
        ...
        <!--</p>-->
        <!--<div v-if="telescopic">-->
        <!--&lt;!&ndash;<table class="tableProduct"  style="margin-bottom: 0;">&ndash;&gt;-->
          <!--&lt;!&ndash;<thead>&ndash;&gt;-->
           <!--&lt;!&ndash;<tr>&ndash;&gt;-->
             <!--&lt;!&ndash;<td v-for="(item,index) in theadList" :key="index">{{item}}</td>&ndash;&gt;-->
           <!--&lt;!&ndash;</tr>&ndash;&gt;-->
          <!--&lt;!&ndash;</thead>&ndash;&gt;-->
        <!--&lt;!&ndash;</table>&ndash;&gt;-->
          <!--<table class="tableProduct" style="margin: 0;"  v-for="(item,index) in productList.tableListData" :key="index" :class="{active:item.status == 1,otherTable:index !==0,lastTable:index==(productList.tableListData.length-1)}">-->
          ...
          <!--<tbody>-->
           ...
           <!--<tr  v-for="(todo,index) in item.mountings" :class="{onlyClass:true,firstClass:index===0,lastClass:index==(item.mountings.length-1)}" :key="index">-->
             <!--<td colspan="14">-->
               <!--<span>-->
        ...
        <div class="left">
          ...
          <table :class="{edit:this.isEdit()}">
            <tr>
              ...
              <td class="fontWidth">状态</td><td>{{dataObj.orderStatus | orderStateShow|placeholder}}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="fontWidth">预约时间</td><td>{{dataObj.makeTime||placeholder}}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="fontWidth">联系人</td><td> {{dataObj.contactsName||placeholder}}</td>
              <td class="fontWidth">工单耗时</td><td>{{orderData.completeTimeLimit}}</td>
            </tr>
            <tr>
              <td class="fontWidth">联系人手机号</td><td>{{dataObj.tel||placeholder}}</td>
              <td class="fontWidth">准时偏差值</td><td>{{orderData.deviation}}</td>
            </tr>
            <tr>
              <td rowspan="2" class="fontWidth">服务城市</td> <td rowspan="2">{{dataObj.city||placeholder}}</td>
            ...
            <tr>
              <td rowspan="2" class="fontWidth">服务地址</td><td rowspan="2">{{dataObj.serveAddress||placeholder}} </td>
            ...
            <tr>
              <td class="fontWidth">工程师姓名</td><td colspan="3">{{dataObj.masterName|placeholder}}</td>
            </tr>
            <tr>
              <td class="fontWidth">工程师手机号</td><td colspan="3">{{dataObj.masterPhoneNum|placeholder}}</td>
            </tr>
            <tr>
              <td class="fontWidth">工程师类型</td><td colspan="3"><span v-if="!!masterInfos"> {{masterInfos.type|masterType}}</span> <span v-else>无</span></td>
            </tr>
            <tr>
              <td class="fontWidth">工程师工号</td><td colspan="3">{{dataObj.masterId||placeholder}}</td>
            </tr>
  ...
  export default {
    ...
    props:["orderDetailed","quiry",'drawbackIsShow','addRemarksIsShow','replaceMaster','complainFn',
     //工单报备     罚款工程师             改约时间         新增服务产品addSaverProduct        催单
      'unusual','masterImposeIsShow','changeTimeIsShows',                             'reminder',   'yuYueTimeIsShow','replacedata'
    ],
    components:{
      alertInfo,
      changTime,
