                ...
                <div class="dable_lsit" >
                  ...
                  <table cellSpacing="0px" cellpadding="0"  id="table">
                    ...
                    <tr v-for="(item,index) in tableListData.list">
                      ...
                      <!--工单渠道-->
                      <td>
                        <span v-if="item.serviceMountings.coreMainOrder" v-show="item.serviceMountings.coreMainOrder.officialPartnerSubsetName">{{item.serviceMountings.coreMainOrder.officialPartnerSubsetName}}-</span><span v-if="item.serviceMountings.coreMainOrder">{{item.serviceMountings.coreMainOrder.officialPartnerName?item.serviceMountings.coreMainOrder.officialPartnerName:"无"}}</span>
                        <span v-if="!item.serviceMountings.coreMainOrder">无</span>
                      </td>
                      <!--渠道质保-->
                      <td>
