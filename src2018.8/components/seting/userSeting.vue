  ...
  <div id="app">
    <div class="container">
      ...
      <div class="dable_lsit">
        <!--导出-->
        <div class="derive">
          <el-button @click="roleSetting" size="large" v-show="$isButtonObj('bn-master-account-newaccount')">角色设置</el-button>
        </div>
        <!--<div class="derive">
...
//      <!--弹窗功能start-->
      ...
      roleSetting(){
        window.open(this.$common.role_api_host)
      },
//      <!--弹窗功能end-->
