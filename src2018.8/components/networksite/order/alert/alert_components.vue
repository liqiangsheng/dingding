            ...
            <table cellSpacing="0px" cellpadding="0">
              ...
              <tr v-for="(item,index) in replaceMasterObj">
                <td  @click="isCheckbox(item,index)">
                  <el-radio style="width:100%;height:100%" class="radio" v-model.trim="replaceMasterObj.radio"
                            :label="index">{{v}}
                  </el-radio>
                </td>
                <td>
    ...
    methods: {
      isCheckbox(item,index){
        let o = {params:{
          ...
          "type":"2",
          "keywords":"",
          "dateStr":this.data.appointmentDatetime?this.$moment(this.data.appointmentDatetime).format("YYYY-MM-DD HH:mm:ss"):""
          }
        };
