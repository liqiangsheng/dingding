  ...
  <div id="app">
    <div class="container">
      ...
      <div class="selector_list">
        ...
        <div class="list">
          结算日期区间：
          <DatePicker v-model.trim="timeQuantum" format="yyyy/MM/dd" type="daterange" placement="bottom-end"
...
<script>
  ...
  export default {
    ...
    created(){
      let siteId='';
      if(localStorage.getItem("userInfo"))siteId=JSON.parse(localStorage.getItem("userInfo")).id;
      this.quiry();
