  ...
  <div id="app">
    <div class="container">
      ...
      <div class="dable_lsit" >
        ...
        <table cellSpacing="0px" cellpadding="0">
          ...
          <tr v-for="(item,index) in tableList">
            ...
            <!--价格-->
            <td>
              <el-input type="number" min="1" v-model.trim="item.price"></el-input>
            </td>
            <td>
      ...
      <!-- <div v-show="isAdd" class="btn_inquiry" @click="saveProduct">
        ...
        <add-parets :data="isAddParets" :isAddOrder="isAddOrder" :query="getTableList" v-if="isAddParets.isShow"></add-parets>
...
//      }
    ...
    methods: {
      preserve(item){
          let url=`${this.$apidomain}/servicemountings/areaMountingsRenew`,
              params={"id":item.id,"price":item.price-0,"name":item.name};
              this.$http.post(url,params).then(res=>{
                let data=res.data;
                data.code==="0000"?this.$queryFun.successAlert.call(this,"保存成功","1"):this.$queryFun.successAlert.call(this,data.error,"0");
                this.getTableList();
              })
      },
      getTableList(){
        let url=`${this.$apidomain}/servicemountings/findmountingsdetailsbyserviceid?serviceId=${this.isAddOrder.data["id"]}`;
