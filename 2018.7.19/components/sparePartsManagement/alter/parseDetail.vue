          ...
          <table v-show="jiantouShow1" id="parseInfo">
            ...
            <tbody>
               <tr>
                 ...
                 <td>{{parseInfo.serviceName}}</td>
                 <td>{{parseInfo.brand}}</td>
                 <td>{{parseInfo.model}}</td>
                 <td>{{parseInfoOne.name}}</td>
                 <td>{{parseInfoOne.barCode}}</td>
                 ...
                 <td class="cursor" @click="lookImg(name='配件图片',parseInfoOne.machinePicture,parseInfoOne.partsBarCode?parseInfoOne.partsBarCode:null)">查看</td>
               </tr>
            </tbody>
    ...
    methods: {
      lookImg(v,data,data1,data2){ //查看图片
        ...
        if(v=== '机器图片'){
          ...
          if(data1 == null){
            this.isPotos.potosimg = [data];
            this.isPotos.testName = ["配件图片"];
          }else{
