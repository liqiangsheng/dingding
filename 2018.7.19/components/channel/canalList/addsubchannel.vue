          ...
          <ul>
            <li>
              ...
              <el-select
                ...
                @change="selector(city,city.SourceType,city.SourceTypeValue)">
                <el-option
            ...
            <li id="ch_option_line">
              ...
              <el-input
                placeholder="请填写详细地址"
                v-model.trim="selectorBehindObj.address">
              </el-input>
            </li>
    ...
    methods: {
      submitAdd(){
        ...
        if(!this.selectorBehindObj["cityId"]){
          ...
          return this.$message({
            message: `请填写渠道名称，长度不超过20字符，不可输入标点符号，长度不超过20字符`,
          });
