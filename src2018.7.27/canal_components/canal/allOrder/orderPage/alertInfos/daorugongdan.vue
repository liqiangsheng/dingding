  ...
  <div>
    <div class="creditIsRunningLow"><!--背阴-->
      ...
      <div class="creditIsRunningLow_box">
        ...
        <div class="footer">
               <p><el-button type="primary" @click="allClick">查看所有工单</el-button><el-button  @click="nextClick">继续下单</el-button></p>
...
<script>
  export default {
    ...
    methods: {
      close(){ //传值给父级
        this.$emit("isClose",{isBool:false,value:""});
      },
      allClick(){ //查看所有工单
        this.$router.push({path:"/census/canalCensus"})
        location.reload()
      },
      nextClick(){//继续下单
       this.close();
