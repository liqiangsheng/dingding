        ...
        <div class="left_info">
          ...
          <ul>
            ...
            <li>师傅等级:
              ...
              <span v-else>
              <el-select
                v-model="level.SourceTypeValue?level.SourceTypeValue:dataObj.level"  placeholder="请选择"
            ...
            <li v-if="this.dataObj.type!=='3'">所属网点:{{dataObj.site|placeholder}}</li>
            <li v-if="this.isEdit()&&this.dataObj.type==='3'">
              所属网点:
              <el-select
