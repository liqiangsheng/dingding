...
//      this.getData({optionLists:this.optionList,key:"sourceId",data:this.$store.state.findchannel,resName:"name"})
      ...
      //console.log(this.$store.state.findchannel,'主渠道')
...
//      this.labeloptions = this.$store.state.mainChannel;
//      console.log(this.labeloptions,'0000000')
//      console.log(this.$store.state.mainChannel,'12313123131')
    },
    methods: {
//      催单
      reminder(item){
