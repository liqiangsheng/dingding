...
//        let ControllerUrl = `${this.$apidomain}/officialProductLabelController/all?serviceId=${id}`;
      ...
      deleteHistory(v,i){
        let detailUrl = `${this.$apidomain}/officialProductLabelController/delete?serviceId=${v.serviceId}&serviceBrand=${v.serviceBrand ? v.serviceBrand : ""}&serviceModel=${v.serviceModel ? v.serviceModel : ""}&type=3`;
