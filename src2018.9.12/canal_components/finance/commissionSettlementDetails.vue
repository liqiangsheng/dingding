        ...
        <div class="center">
              <div class="center_data">
                  <ul>
                      ...
                      <li>
                          <span>结款状态</span>
                        <el-select v-model.trim="jiekuanzhuangtai" placeholder="请选择">
                            <el-option
                      ...
                      <li>
                          <span>子渠道</span>
                        <el-select v-model.trim="ziqudao" placeholder="请选择" @change="selector(ziqudao)">
                            <el-option
              ...
              <div class="list">
                  <ul>
                      <li>
                           <span>订单号</span>
                        <el-input placeholder="请填写订单号" v-model.trim="gongdanhao"></el-input>
                      </li>
                      <li>
                           <span>手机尾号</span></span>
                        <el-input placeholder="请填写手机后四位" v-model.trim="tel"></el-input>
                      </li>
                  </ul>
              </div>
              <div class="btn">
         ...
         <div class="tableList">
            <table border="0" cellspacing="0" >
                <thead>
                    <tr>
                      <th>
                        <el-checkbox v-model.trim="checked" @change="wholeSelector(dataList,checked)"></el-checkbox>
                      </th>
                        <th>序号</th>
