                         ...
                         <div class="userInformation">
                              ...
                              <div class="userInfos">
                                    <ul class="userInfosBox">
                                      ...
                                      <li><span style="flex-grow: 1">预约时间</span><span>{{detailData.appointmentDatetime|moment('YYYY-MM-DD HH:mm:ss')}}</span><span style="flex-grow: 1">完结时间</span><span>{{detailData.createTime|moment('YYYY-MM-DD HH:mm:ss')}}</span></li>
