                         ...
                         <div class="userInformation">
                              ...
                              <div class="userInfos">
                                    <ul class="userInfosBox">
                                      <li><span style="flex-grow: 1">订单号</span><span>{{detailData.id}}</span><span style="flex-grow: 1">订单状态</span><span>{{detailData.state|orderStateShow}}</span></li>
                                      ...
                                      <li><span style="flex-grow: 1">预约时间</span><span>{{detailData.appointmentDatetime|moment('YYYY-MM-DD HH:mm:ss')}}</span><span style="flex-grow: 1">完结时间</span><span>{{detailData.canWithdrawDepositAmount|moment('YYYY-MM-DD HH:mm:ss')}}</span></li>
                                      ...
                                      <li><span style="flex-grow: 1">工程师工号</span><span>{{detailData.masterId}}</span><span style="flex-grow: 1">订单类型</span><span>{{detailData.type|orderType}}</span></li>
