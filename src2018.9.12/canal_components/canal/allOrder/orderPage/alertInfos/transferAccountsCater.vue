        ...
        this.$http.post(url,obj).then(res=>{
          ...
          if(res.data.code =="0000"){
            ...
            if(res.data.result.payState == "2"){
              let mainOrderIdObj={};
              mainOrderIdObj.mainOrderId = JSON.parse(localStorage.getItem("mainOrderId"));
              mainOrderIdObj.officialPartnerId = JSON.parse(localStorage.getItem("userInfo")).channelId;
