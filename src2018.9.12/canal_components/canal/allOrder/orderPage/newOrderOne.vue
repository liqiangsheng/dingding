...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.chushiId.channelSettleType == "1"){
...
//        this.$queryFun.successAlert.call(this,"请重新选择日期");
      ...
      paramsData(){  //传数据给后台
        ...
        return Object.assign({
          "officialPartnerId":this.chushiId.id, //主渠道ID
      ...
      getTableList(params){
        ...
        this.$http.post(url,params).then(res=>{
              if(res.data.code == "0000"){
                    if(this.chushiId.channelSettleType == "1"){
                      this.$queryFun.successAlert.call(this,"订单提交成功","1");
                      ...
                      mainOrderIdObj.officialPartnerId = this.chushiId.id;
