...
//      isRouterAlive:true
  ...
  created(){
    this.reload();
//    let cityUrl = this.$apidomain+"/areaDomain/findAreaDomainList?modelName="+getSession("KEY")[0];  //城市暂时注释
...
//    })
  ...
  mounted(){
    window.addEventListener('beforeunload', e => this.reload())
  },
  destroyed(){
    window.removeEventListener('beforeunload', e => this.reload())
  }
}
</script>
<style>
