  ...
  <div id="app">
    ...
    <el-dialog style="z-index:999999;"  :visible.sync="dialogTableVisible" size="min" v-if="dialogTableVisible">
      <ul class="alert_forbidden_text">
        <li>
          <el-input v-model.trim="newPass" placeholder="请填写新密码" type="password"></el-input>
        </li>
        <li>
          <el-input v-model.trim="affirmPas" placeholder="请确认密码" type="password"></el-input>
