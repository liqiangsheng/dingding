    ...
    <div class="container">
      ...
      <div class="content">
        <div class="left_info">
          ...
          <ul v-else>
            <li>工程师类别 :{{selectorBehindObj.masterType | mastertype}}</li>
...
//          else{
//            this.optionList[0].isBool = "请选择工程师类别";
//          }
          if(new1[1].SourceTypeValue != ""){
            this.optionList[1].isBool = "";
          }
//          else{
//            this.optionList[1].isBool = "请选择工程师等级";
//          }
    ...
    methods: {
      ...
      add(value) {
        ...
        if (!this.selectorBehindObj.masterType || "" == this.selectorBehindObj.masterType) {
          this.optionList[0].isBool = "请选择工程师类型"
          return;
        }else{
          this.optionList[0].isBool = ""
        }
