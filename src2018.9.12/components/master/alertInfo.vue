    ...
    <div class="container">
      ...
      <div class="scrollbar content">
        <div class="left_info">
          ...
          <ul>
            <li>工程师姓名：{{dataObj.masterInfo.name |placeholder}} </li>
            <li>工程师手机号:{{dataObj.masterInfo.phoneNum |placeholderTel}}</li>
            ...
            <li>服务工种:{{ dataObj.skills | listshow("1") | placeholder }} </li>
  ...
  export default {
    ...
    created(){
      ...
      this.$http.get(url).then(res=>{
        ...
        this.dataObj.qualificationImg = images.slice(3);

//        this.dataObj.qualificationImg
//         = images[3];  //资格执照
