  ...
  <div id="app">
    <div class="container">
      ...
      <div class="scrollbar content">
        <div class="left_info">
          <p class="title">工程师信息</p>
          <ul>
            <li>工程师编号:{{dataObj.id|placeholder}}</li>
            <li>工程师姓名：{{dataObj.name}}</li>
            <li>工程师手机号:
            ...
            <li>
              ...
              <span v-else>
              <el-select
                v-model.trim="city.SourceTypeValue" placeholder="请选择服务城市"
                @change="selector1(city,city.SourceType,city.SourceTypeValue)">
                <el-option
                  v-for="(items,index)  in city.SourceType"
                  :key="index"
                  :value="items.value"
                >
              </el-option>
            ...
            <li v-if="!this.isEdit()">工程师类别:{{dataObj.type| }}</li>

            <li v-else>
              工程师类别:
              <el-select
                v-model.trim="type.SourceTypeValue" placeholder="请选择工程师类别"
                @change="selectorType(type,type.SourceType,type.SourceTypeValue)">
                <el-option
                  v-for="(items,index)  in type.SourceType"
                  :key="index"
                  :value="items.value"
                >
                </el-option>
            ...
            <li>工程师等级:
              ...
              <el-select
                ...
                <el-option
                  v-for="(items,index) in level.SourceType"
                  :key="items.index"
                  :value="items.value"
                >
              </el-option>
            ...
            <li v-if="isEdit()&&dataObj.type==='3'">
              ...
              <el-select
                ...
                @change="selectorType(siteId,siteId.SourceType,siteId.SourceTypeValue)">
                <el-option
                  v-for="(items,index) in siteId.SourceType"
                  :key="items.index"
                  :value="items.value"
                >
                </el-option>
            ...
            <li>开户行:
              ...
              <span v-else>
                <el-select   v-model.trim="dataObj.bankOfDeposit" placeholder="请选择开户行" @change="selector5(bank,bank.bankName,dataObj.bankOfDeposit)">
                <el-option
                  v-for="(items,index)  in bank.bankName"
                  :key="index"
                  :value="items.name"
                >
                </el-option>
    ...
    created(){
      ...
      this.$http.get(url).then(res=>{
        ...
        switch (this.dataObj.type){
          case "1":masterType="自营工程师";break;
          case "2":masterType="兼职工程师";break;
          case "3":masterType="网点工程师";this.getSiteList();break;
        }
        ...
        let images =this.dataObj.idPhotos?this.dataObj.idPhotos.split(","):[];
        ...
        if(this.dataObj.level === "Primary"){
          ...
          this.level.SourceTypeValue="中级工程师"
