...
//    }
    ...
    setTimeout(()=>{
        if(this.$store.state.partsAdministrationObj.partsData){
          this.productName = this.$store.state.partsAdministrationObj.partsData.fullName;
          this.changeValue = this.$store.state.partsAdministrationObj.partsData.changeValue;
    ...
    watch:{
      "$store.state.partsAdministrationObj":{
