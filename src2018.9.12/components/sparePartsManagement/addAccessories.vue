  ...
  export default {
    ...
    data() {
      return {
        ...
        theadsName:["序号","配件名称","分类","产品全称","订单号","订单渠道","渠道质保","工程师信息","申领时间","取件方式","是否已返还旧件","申领状态","操作"],
        tableList:{
          pageNo:1,
          pageSize:20,
          total:0,
    ...
    watch:{
      "$store.state.parseDetailiD.isBool":function(newl,oldl){ //监听订单详情配件列表传过来的id
    ...
    methods: {
      ...
      paramsData(){// 请求参数的参数
        ...
        return {
            ...
            "mainOrderId":this.inputParams.orderName,   //订单号
