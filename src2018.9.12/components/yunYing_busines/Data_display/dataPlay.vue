  ...
  export default {
    ...
    data() {
      return {
        ...
        statisticsDateStartStr3:"",
        statisticsDateEndStr3:"",
        statisticsDateStartStr4:"",
        statisticsDateEndStr4:"",
        chartSettings:{
          area: true
        },
        chartData:{
...
// 详情页面 end
    ...
    methods: {
      ...
      paramsData2(){
        return {params: {
          "statisticsDateStartStr":this.statisticsDateStartStr2,
          "statisticsDateEndStr":this.statisticsDateEndStr2,
        }}
      },
      quiry3(isTime){
        if(isTime&&this.timeQuantum3){
          this.statisticsDateStartStr3 = this.$moment(this.timeQuantum3[0]).format('YYYY-MM-DD');
          this.statisticsDateEndStr3 = this.$moment(this.timeQuantum3[1]).format('YYYY-MM-DD');
        }else{
          this.statisticsDateStartStr3 = "";
          this.statisticsDateEndStr3 =""
        }
      ...
      paramsData3(){
        return {params: {
          "statisticsDateStartStr":this.statisticsDateStartStr3,
          "statisticsDateEndStr":this.statisticsDateEndStr3,
        }}
      },
      quiry4(isTime){
        if(isTime&&this.timeQuantum4){
          this.statisticsDateStartStr4 = this.$moment(this.timeQuantum4[0]).format('YYYY-MM-DD');
          this.statisticsDateEndStr4 = this.$moment(this.timeQuantum4[1]).format('YYYY-MM-DD');
        }
      ...
      paramsData4(){
        return {params: {
          "statisticsDateStartStr":this.statisticsDateStartStr4,
          "statisticsDateEndStr":this.statisticsDateEndStr4,
        }}
      },
      isShowContainer(){
