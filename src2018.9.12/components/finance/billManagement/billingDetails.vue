        ...
        <div class="center">
              <div class="center_data">
                  <ul>
                      <li>
                           <span>订单号</span>
                        <el-input placeholder="请填写订单号" v-model.trim="gongdanhao" clearable></el-input>
                      </li>
                      <li>
                          <span>完结时间</span>
                           <el-date-picker
                             v-model.trim="finishDate"
                             type="date"
                             placeholder="选择日期"
                ...
                <thead>
                    <tr>
                      ...
                      <th>序号</th>
                        ...
                        <th>服务区域</th>
                        <th>子渠道</th>
                        <th>订单总费用 (元)<img src="../../../../static/images/paixu.png"></th>
  ...
  export default {
    ...
    created(){
      ...
      //parameter.type =  this.$store.state.billDateTime.billType;
         ...
         const url = `${this.$common.apidomain}/officialPartnerSubsetInfo/findlistOfficialPartnerSubsetInfo?officialPartnerId=${this.$route.query.id}`;
            ...
            checkbox(index){
                ...
                paramsData(){
                    ...
                    return{
                        ...
                        "mainOrderId":this.gongdanhao,              //订单号
