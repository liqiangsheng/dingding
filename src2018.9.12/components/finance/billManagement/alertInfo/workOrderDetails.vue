                         ...
                         <div class="userInformation">
                              ...
                              <div class="userInfos">
                                    <ul class="userInfosBox">
                                      <li><span>订单号</span><span>{{detailData.id}}</span><span>订单状态</span><span>{{detailData.state|orderStateShow}}</span></li>
                                      ...
                                      <li><span>预约时间</span><span>{{detailData.appointmentDatetime|moment('YYYY-MM-DD HH:mm:ss')}}</span><span>完结时间</span><span>{{detailData.createTime|moment('YYYY-MM-DD HH:mm:ss')}}</span></li>
                                      <li><span>服务时长</span><span>{{detailData.workTimeLimit}}</span><span>子渠道</span><span>{{detailData.officialPartnerSubsetName}}</span></li>
                                      <li><span>工程师工号</span><span>{{detailData.masterId}}</span><span>订单类型</span><span>{{detailData.type|orderType}}</span></li>
