  ...
  <div>
      ...
      <div class="detailAlert_box">
            ...
            <div class="details-list">
               <p>1. 如需重新服务或维护该订单费用,报成功异常后请客服挂起该订单;</p>
               <p>2. 如需重新计算该订单的提点,则报异常后,维护对象提点后再次结算该订单;</p>
              <textarea v-model.trim="text" placeholder="请填写账号异常原因"></textarea>
            </div>
            <!-- 底部按钮 -->
            <div class="btn">
