...
export function currentChange(val) {
  ...
  if(_this.tableListData.list.length !==0){
    _this.getTableList(params);
  }
    //_this.getTableList(params);
}
...
export function lastPages() {
    if (_this.showPages === _this.lastPage) {
...
export function getTableListData(data,isCheckboxList,th) {
  ...
  _this.tableListData.list.forEach((obj,i)=>{
  ...
  _this.tableList = data.result.list;
  ...
  _this.showPages = data.result.pageNum;
    _this.currentPageSize = data.result.pageSize;
    _this.total = data.result.total;
    // _this.pageTotal = data.result.pageTotal?data.result.pageTotal:data.result.pages;
  _this.pageTotal = data.result.pages;
...
export function buttonStatus(input){
  if(input==='03'||input==='04'||input==='05'||input==='06'||input==='07'||input==='08'||input==='09'||input==='10'||input==='11'||input==='12'||input==='13'||input==='14'||input==='15'||input==='16'||input==='17'||input==='18'||input==='19'||input==='21'||input==='20'){
    return true;
  }else{
    return false;
  }
...
export function sendOrderFilter(input){
  if(input==='03'||input==='04'||input==='05'||input==='06'||input==='07'||input==='08'||input==='20'){
    return true;
  }else{
    return false;
  }
...
export function changeTimeFilter(input){
  if(input==='01'||input==='03'||input==='05'||input==='06'||input==='07'||input==='08'||input==='04'||input==='20'||input==='21'){
    return true;
  }else{
    return false;
  }
...
export function cancelOrderFilter(input){
  if(input==='01'||input==='03'||input==='05'||input==='06'||input==='07'||input==='08'||input==='10'||input==='11'||input ==='04'||input==='21'||input==='20'){
    return true;
  }else{
    return false;
  }
...
export function addProductFilter(input){
  if(input==='01'||input==='03'||input==='04'||input==='05'||input==='06'||input==='07'||input==='08'||input==='10'||input==='21'||input==='20'){
    return true;
  }else{
    return false;
  }
