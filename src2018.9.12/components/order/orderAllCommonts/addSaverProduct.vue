<template>
  <div id="app">
    <el-dialog style="z-index:99999"   :visible.sync="isAddProduct.isShow" size="tiny">
      ...
      <ul>
        <li>订单号：{{isAddProduct.data.id}}</li>
        <li>
          服务清单：
      ...
      <ul class="alert_forbidden_text">
        ...
        <li id="product_option">
          ...
          <el-select
            ...
            v-model.trim="addProductInfo.productMsg.SourceTypeValue" placeholder="请选择产品"
          >
            <el-option
    ...
    methods: {
      confirm(isAddProduct,tableList){
        ...
        this.$http.post(url,params).then(r=>{
          let data=r.data;
          if(data.code==='0000'){
            this.$queryFun.successAlert.call(this, '新建成功');
