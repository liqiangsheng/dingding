    ...
    <div>
      <el-dialog style="z-index:999999;"   :visible.sync="isAdd.isShow">
          <ul class="ullist scrollbar">
            <li>
              <span>订单号: </span>{{list.mainOrderId}}
            </li>
            <li>
              <span>订单类型: </span>{{list1.type|orderType}}
            </li>
            <li>
            ...
            <li>
              <span>工程师姓名: </span>{{list.masterName}}
            </li>
            <li>
              <span>工程师手机号: </span>{{list1.masterPhoneNum}}
            </li>
            <li>
              <span>联系人手机号: </span>{{list1.linkmanPhoneNum||"未绑定"}}
            </li>
            <li>
              <span>订单耗时: </span>{{list1.completeTimeLimit}}
            </li>
            <li>
              <span>订单类型: </span>{{list.orderType|orderSourceShow}}
            </li>
            <!--<li>-->
            ...
            <li>
              <span>订单报备次数: </span>{{list1.abnormalHangSize}}
            </li><li>
