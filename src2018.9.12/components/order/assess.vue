  ...
  <div id="app">
    ...
    <div class="container">                       <!--订单评价-->
      <div class="selector_list">
        ...
        <div class="list">
          订单类型 :
          <el-select v-model.trim="orderLabel1" placeholder="请选择订单类型" @change="selector1(orderLabel1)">
            <el-option
      ...
      <div class="footerBnt">
        ...
        <!--导出-->
        <div  style="margin-right: 150px;display: inline-block;float: right;margin-right: 150px">
      ...
      <div class="dable_lsit">
        ...
        <table cellSpacing="0px" cellpadding="0">
          ...
          <tr class="theads">
            <!--复选-->
            <!--<th>-->
              <!--<el-checkbox v-model.trim="checked" @change="wholeSelector(tableList.list,checked)"></el-checkbox>-->
            <!--</th>-->
          ...
          <tbody>
          <tr v-for="(item,index) in tableList.list">
            <!--复选-->
            <!--<td>-->
              <!--<el-checkbox v-model.trim="isCheckboxList[index]"-->
                           <!--@change="isCheckbox(tableList.list,index)"></el-checkbox>-->
            <!--</td>-->
            <td>
              {{index+1}}
            </td>
            ...
            <td >
              ...
              <span @click="l_dial_contact(item.linkmanPhoneNum,item.id)">
...
//          '状态',
    ...
    methods: {
      ...
      reset(){//重置
        ...
        this.masterName = "";
        this.orderLabel = "";
        this.selectorBehindObj.labelId = "";//分类
        this.selone1 = ""; //订单类型
...
//      <!--分页查询数据对象功能组合start-->
      ...
      getTableList(params){
        let url=this.$apidomain+"/manage/order/findEvaluatePage";
...
//
        ...
        let  obj = {
          ...
          "masterName":this.masterName,
          //"orderLabel":this.selone,
          'orderLabel':this.selectorBehindObj.labelId,         //订单分类
