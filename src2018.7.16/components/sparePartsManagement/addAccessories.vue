                ...
                <div class="dable_lsit" >
                  ...
                  <table cellSpacing="0px" cellpadding="0"  id="table">
                    ...
                    <tr v-for="(item,index) in tableListData.list">
                      ...
                      <!--操作-->
                      <td id="iconS">
                          <span v-if="item.state == '10'||item.state == '50'" @click="okAlter(name='申请通过')">通过</span>
                          ...
                          <span v-if="item.state == '10'||item.state == '20'||item.state == '30'||item.state == '40'||item.state == '50'||item.state == '60'"  id="detailGoods" @click="detailAlter(name='申领详情')">详情</span>
                      </td>
