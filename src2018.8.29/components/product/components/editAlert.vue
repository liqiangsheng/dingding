        ...
        <table style="float:left;">
          <tbody>
            ...
            <tr>
              <td>上门费（元）</td>
              <td>
                <el-input style="width:100px;" v-model.trim="tableList.price1" type="number" min="0"></el-input>
              </td>
            </tr>
            <!---->
            <tr>
              <td>上门费是否叠加</td>
              <td>
                <el-select placeholder="请选择" style="width:100px;" v-model.trim="tableList.isCollectDoorFee">
            ...
            <tr>
              <td>价格（元）</td>
              <td>
                <el-input style="width:100px;" v-model.trim="tableList.price2" type="number" min="1">
                  </el-input>
              </td>
            </tr>
             <!---->
            <tr>
              <td>质保时间（天）</td>
              <td>
                <el-input style="width:100px;" v-model.trim="tableList.warrantyDatetime" type="number" min="0">
                </el-input>
              </td>
            </tr>
            <!---->
  ...
  export default {
    ...
    methods: {
      ...
      preserveSubmit(grounding){
        ...
        if(this.tableList.isCollectDoorFee == "是"){
          this.tableList.isCollectDoorFee = "1";
        }else if(this.tableList.isCollectDoorFee == "否"){
          this.tableList.isCollectDoorFee = "0";
        }
        ...
        let url=`${this.$apidomain}/serviceinfo/saveServiceAreaInfo`,
            ...
            params={
              ...
              "isCollectDoorFee": this.tableList.isCollectDoorFee,
      ...
      getTableList(){
//        serviceinfo/areaInfoRenew
        let url=`${this.$apidomain}/serviceinfo/areaInfoRenew?id=${this.data.data["id"]}`;
//        let url=`${this.$apidomain}/serviceinfo/findOneAreaInfo?serviceId=${this.data.data["id"]}&areaId=${this.selectorBehindObj.cityId}`;
        this.$http.get(url).then(r=>{
          ...
          if(this.data.data.areaInfos){
            ...
            this.state=data.result.state;
              if(this.tableList.isCollectDoorFee == "1"){
                    this.tableList.isCollectDoorFee = "是";
                  }else if(this.tableList.isCollectDoorFee == "0"){
    ...
    created() {
      this.getTableList();
      console.log(this.$store.state.cityData,'城市')
