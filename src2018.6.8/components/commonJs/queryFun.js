export default {
  ...
  getAddress(e){
    if(!!e.value){
      this.$jsonp(`http://apis.map.qq.com/ws/place/v1/suggestion?region=${!!e.city?e.city:""}&region_fix=${!!e.city?'1':"0"}&key=NIGBZ-2JCWF-P3HJT-NTO5F-HJX75-GWFDD&output=jsonp&keyword=${e.value}`).then(res=>{
