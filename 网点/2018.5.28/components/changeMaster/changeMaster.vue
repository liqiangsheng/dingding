  ...
  import storage from "@/assets/js/storage"
    export default {
        ...
        methods: {
          ...
          getMasterOrder(id){
            let params={
                ...
                "workerid":id,
                "keywords":"",
                "dateStr":this.$moment(this.routeParams.date-0).format("YYYY-MM-DD HH:mm:ss"),
              },
      ...
      mounted(){
        ...
        created() {
          this.$http.get(`${this.$common.apidomain}/siteInfo/findValidMasters`,this.paramsData()).then(res => this.$httpFilter(res).then( data => this.masterList = data.result ));
