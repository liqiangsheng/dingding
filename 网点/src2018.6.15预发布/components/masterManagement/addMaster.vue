...
//        this.$router.push({path:`/addMaster`,query:{data:this.workerList}})
      ...
      getCityList() {
        ...
        this.$http.get(url).then(res => {
          ...
          if (data.code === '0000') {
            ...
            console.log(this.cityList, '2222')
          } else {
      ...
      //传给后台参数
      params() {
        // console.log(this.workerList, '11')
        if (this.workerList) {
        ...
        // console.log(this.cityList,'cityID')
        this.cityList.forEach((obj, i) => {
          this.cityName = obj.id == this.selectCity ? obj.name : '';
        })
        // console.log(this.selectCity, this.cityName,'99999')
        return {
