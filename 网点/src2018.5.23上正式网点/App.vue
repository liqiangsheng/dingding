      ...
      computed: {
        ...
        watch:{
           "$route":function(a,b){
             ...
             this.addMaster = a.fullPath.indexOf("/addMaster") != -1 || a.fullPath.indexOf("/serviceArea") != -1 || a.fullPath.indexOf("/serviceWorker") != -1 || a.fullPath.indexOf('/editMasterDetails') != -1 ? false : true;
