<template>
  <div class="addMasterList">
    <C_header title="服务工种" right_number="4" :editResetWorker='resetWorker' left_number='2'></C_header>
...
//      console.log(this.$store.getters.skills, '//工种')
    ...
    methods: {
      //服务工种数据
      getWorkList() {
//        console.log(this.$route.query.data,'12121212')
...
//        this.$router.push({path: `/editMasterDetails`, query: {workerData: this.workerList, areaList: this.areaList}})
      }
    }
  }
</script>
