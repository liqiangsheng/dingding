...
//                   this.$router.go(-2);
        ...
        mounted(){
          ...
          setInterval(() => getMessage.call(this),300000)
      ...
      computed: {
        ...
        watch:{
           "$route":function(a,b){
             ...
             this.addMaster = a.fullPath === "/addMaster" || a.fullPath === "/serviceArea" || a.fullPath === "/serviceWorker" || a.fullPath === '/editMasterDetails' ? false : true;
             if(a.fullPath === "/masterOrder"||a.fullPath === "/dotInformation"||a.fullPath ==="/messageCenter"||document.title === "工单详情"||a.fullPath ==="/masterPosition"||a.fullPath ==="/masterDisable"){
               ...
               console.log(JSON.parse(localStorage.getItem("masterDetail")))
