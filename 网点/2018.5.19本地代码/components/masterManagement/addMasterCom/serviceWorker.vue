    ...
    methods: {
      ...
      selectClass(item, indexs) {
        ...
        if (this.flag[indexs]) {
          ...
          // console.log(this.selectLabel,'选中label')
        } else {
          this.$set(this.isReduce, indexs, false)
      ...
      selectChild(d, indexs, index) {
        ...
        if (this.flag_show[indexs][index]) {
          ...
          //this.selectData.splice(this.selectData.findIndex(v => v.id === this.workerList[indexs].cities[index].id),1);
          this.selectData.splice(index, 1)
          this.selectLabel.splice(index, 1);
          this.$set(this.flag_show[indexs], index, false);
          // console.log(this.selectData,'删除id')
          // console.log(this.selectLabel,'删除label')
        } else {
          // console.log(this.workerList[indexs].cities[index].label,'label')
      ...
      resetWorker() {
        ...
        console.log(this.$store.getters.serviceWorker, '保存服务工种数据')
      }
    }
  }
</script>
