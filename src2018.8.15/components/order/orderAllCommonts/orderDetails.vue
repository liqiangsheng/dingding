      ...
      <div class="productInfo">
        ...
        <div v-if="telescopic">
          ...
          <table class="tablePrice">
            <tr>
              <td>上门费小计<span>￥{{orderData.price1}}</span></td>
              <td>高空费小计<span>￥{{orderData.price4}}</span></td>
              <td>服务费小计<span>￥{{orderData.price2Original}}</span></td>
              <td colspan="2">配件费小计<span style="left: 89%">￥{{orderData.price3}}</span></td>
              <td>工单合计<span>￥{{orderData.originalTotal}}</span></td>
            </tr>
            <tr>
              ...
              <td colspan="2">用券折扣<span style="left: 89%">￥{{orderData.voucherDiscount}}</span></td>
            ...
            <tr>
              ...
              <td>渠道待付款<span>￥{{orderData.pendingFee}}</span></td>
              <td>用户待付款<span>￥{{orderData.waitAmount}}</span></td>
              <td>应付合计<span>￥{{orderData.total}}</span></td>
            </tr>
          </table>
        </div>
      </div>
