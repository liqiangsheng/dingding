      ...
      if(!!editData.id){
        ...
        this.$http.get(url).then(r=>{
          ...
          if(data.code==="0000"){
            ...
            console.log(this.editData,'网点闲情')
        ...
        handler:function(new1,old1){
          if(new1[0].value != ""){
            ...
            if(res2.test(new1[0].value) == false ){
              this.inputs[0].isBool = " 请填写网点名称，长度不超过20字符，不可输入特殊符号"
              return
            }else{
          ...
          if(new1[1].value != ""){
            let res2 = /^[\u4e00-\u9fa5a-zA-Z0-9]{1,20}$/;
            if(res2.test(new1[1].value) == false ){
              this.inputs[1].isBool = " 请填写用户名，长度不超过20字符，不可输入特殊符号"
              return
            }else{
          ...
          if(new1[3].value != ""){
            ...
            if(res2.test(new1[3].value) == false ){
              this.inputs[3].isBool = " 请填写联系人，长度不超过20字符，不可输入特殊符号"
              return
            }else{
