  ...
  <div id="app">
    <div>                                 <!--配件列表-->
      ...
      <div class="container">
        ...
        <div class="dable_lsit">
          ...
          <table id="table" cellSpacing="0px" cellpadding="0">
            ...
            <tr>
              ...
              <!--操作-->
              <td>
                <span class="cursor" style="color: #20A0FF" @click="edit(name='配件列表',item)">编辑</span>
                <span class="cursor" style="color:#E65831 " @click="del(name='配件列表',item)">删除</span>
              </td>
            </tr>
            </tbody>
          </table>
        ...
        <!--table表格结束-->
        <EditPage @isClose="isClose" v-if="editIsShow" :editData="editData"></EditPage>
        <DelPage @isClose="isClose"  v-if="delIsShow" :editData="delData"></DelPage>
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        selectorBehindObj:{},
        tabListName:["序号","配件编号","配件名称","配件费","商品编号","产品名称","服务费类型","操作"]
      }
    },
