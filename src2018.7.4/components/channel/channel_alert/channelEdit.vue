        ...
        <div class="left_info">
          ...
          <ul v-if="isAdd">
            <li v-for="(item,index) in optionList">
              ...
              <span v-if="item.isBool" style="color: red">{{item.isBool}}</span>
            </li>
            <li id="listName">
              ...
              <el-cascader id="labelId" ref="fuwugongzhong"
                           style="width: 260px;margin-left: 14px;height: 40px"
                             ...
                             :props="props1"
                ></el-cascader>
              <span v-if="fuwugongzhongOne" style="color: red">{{fuwugongzhongOne}}</span>
            </li>
          </ul>
          <ul v-else>
        ...
        <div class="right_info">
          ...
          <ul>
            ...
            <li v-for="(item,index) in RemindedList" :key="index">
              ...
              <span v-if="tidianleixingOne" style="color: red">{{tidianleixingOne}}</span>
            </li>
            <li>
              ...
              <span v-if="tidianOne" style="color: red">{{tidianOne}}</span>
            </li>
            <li>
              ...
              <span v-if="numOne" style="color: red">{{numOne}}</span>
