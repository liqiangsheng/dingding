        ...
        <ul class="center">
          <div class="fuwuxinxi">
            ...
            <ul class="yuyuexinxi">
              ...
              <li>　　联系人<span>*</span>
                <el-input v-model.trim="input7" placeholder="请输入内容" style="width: 80%;"></el-input>
              </li>
              <li>联系人手机<span>*</span>
                <el-input v-model.trim="input8" placeholder="请输入内容" style="width: 35%"></el-input>
                　　　<b style="font-weight:100; margin: 0 20px">座机</b>
                <el-input v-model.trim="input6" placeholder="请输入内容" style="width: 34%"></el-input>
              </li>
              ...
              <li>　详细地址<span>*</span>
                <el-input v-model.trim="input4" placeholder="请输入内容" style="width: 80%"></el-input>
              </li>
