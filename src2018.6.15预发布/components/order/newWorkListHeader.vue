      ...
      <div>
        <div class="yuyue">
          ...
          <ul>
            ...
            <li>联系人手机<span>*</span>
              <el-input v-model="input2" placeholder="请输入正确手机号码" style="width: 200px"></el-input>
              　　　<b style="font-weight:100; margin: 0 20px">座机</b>
              <el-input v-model="input6" placeholder="请输入正确座机（非必填）" style="width: 200px"></el-input>
            </li>
...
//          this.timeBoxShow = true;
    ...
    methods: {
      ...
      addOK() {//确定添加
//        cosnole.log(this.selectedOptions2)
//        return;
        if (this.input1 == "") {
