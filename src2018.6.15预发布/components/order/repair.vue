...
//            添加师傅详情结束
    ...
    methods: {
      derivation(){
        let params=Object.assign(this.paramsData().params,{fLabelBusiness:this.fLabelBusiness});
        const url = `${this.$apidomain}/orderquery/createOrderExcelByRework`
      ...
      * */
      returnRepair(i){
        ...
        this.fLabelBusiness=fLabelBusiness;
