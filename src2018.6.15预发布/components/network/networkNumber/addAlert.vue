  ...
  <div id="app">
    <div class="container">
        ...
        <section class="container_content">
          ...
          <aside class="container_content_right">
            ...
            <div v-if="isPassword">
              ...
              <el-input style="width:199px" placeholder="请输入密码" type="password" v-model="selectorBehindObj.password" v-if="isPassword&&!this.isAdd.id"></el-input>
      ...
      <div class="btn_container">
        ...
        <el-button type="primary" @click="submitAdd(false)" class='selector' v-if="!isAdd.id">确定</el-button>
