  ...
  <div id="app">
    <el-dialog style="z-index:999"  :visible.sync="isRepair.isShow">
      ...
      <ul class="alert_forbidden_text">
        ...
        <li>
          工程师工号:  {{isRepair.data.masterId}}
        </li>
        <li>
          工程师姓名:  {{isRepair.data.masterName}}
        </li>
        <li>
          工程师手机号:  {{isRepair.data.masterPhoneNum}}
        </li>
        <li>
          服务时间:
          <DatePicker v-model.trim="newtime" type="datetime" format="yyyy-MM-dd HH:mm" placeholder="选择日期和时间"
