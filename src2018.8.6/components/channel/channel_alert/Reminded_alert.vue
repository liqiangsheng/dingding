    ...
    <div class="container">
      ...
      <div class="content">
        <div class="left_info">
          ...
          <ul v-else>
            <li>工程师类型 :{{selectorBehindObj.masterType|mastertype}}</li>
            <li>工程师等级 :{{selectorBehindObj.masterLevel|masterLevel}}</li>
        ...
        <div class="right_info">
          ...
          <ul>
            <li v-for="(item,index) in RemindedDataList" class="edit_open" v-show="isShow">
              ...
              &nbsp;
              &nbsp;
              <input type="number" v-model.trim="item.shareValue">
              &nbsp;
            ...
            <li>
              {{Reminded[0].name}}
              <el-input-number v-model.trim="number" :min="0" :max="100"></el-input-number>
              <el-select style="width:20%"
                         v-model.trim="Reminded[0].SourceTypeValue"
                         placeholder="请选择"
