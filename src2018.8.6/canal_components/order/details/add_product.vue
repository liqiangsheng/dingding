    ...
    <el-dialog style="z-index:999999"  :visible.sync="isAddProduct.isShow" size="min">
      ...
      <ul class="alert_forbidden_text">
        ...
        <li v-show="label.SourceType.length>0">
          ...
          <!--<el-select-->
          <!--v-model.trim="label.SourceTypeValue" placeholder="请选择" @change="selector(label,label.SourceType,label.SourceTypeValue)">-->
            <!--<el-option-->
          ...
          <Select v-model.trim="labels" multiple style="width:360px">
