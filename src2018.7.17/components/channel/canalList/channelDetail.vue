  ...
  <div id="app">
    <div class="container">
      ...
      <div class="essentialInfo" v-if="telescopic">
        <div>
          <button  @click="edit " v-if="!isEdit()">{{btnName}}</button>
          <button @click="enter()" v-if="isEdit()" style="margin-right: 10px">保存</button>
          <button style="margin-right:10px !important;"  @click="cancelEdit" v-if="isEdit()">取消</button>
          <br>
        </div>
        ...
        <p @click="open3" class="cursor">修改密码</p>
      </div>
      <p>
