  ...
  export default {
    ...
    created(){
      ...
      this.$http.get(url).then(res=>{
        console.log(res);
        this.tbodyS =res.data.result.coreMainOrderExceptionRecords;//备注
        console.log(this.tbodyS)
        this.pianzheng = res.data.result.coreMainOrderSubsidiary;//凭证
        this.zhaopian = res.data.result.coreMainOrderSubsidiary.idPhotos.split(",");
        this.xianshiTime = res.data.result.coreMainOrderSubsidiary.idPhonesTime.split(",");
        console.log(this.pianzheng)
        console.log(this.xianshiTime)
