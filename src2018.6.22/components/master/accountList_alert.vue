        ...
        <div class="left_info">
          ...
          <ul>
            ...
            <li v-if="isEdit()&&dataObj.type==='3'">
              所属网点:
              <el-select
                v-model.trim="siteId.SourceTypeValue" placeholder="请选择"
            ...
            <li>开户行:
              ...
              <span v-else>
                <el-select   v-model.trim="dataObj.bankOfDeposit" placeholder="请选择" @change="selector5(bank,bank.bankName,dataObj.bankOfDeposit)">
                <el-option
