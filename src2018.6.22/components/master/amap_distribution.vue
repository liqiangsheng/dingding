  ...
  export default{
      data(){
          return{
              ...
              iframe_src:'',//师傅分布图
//              iframe_src_link:'http://localhost:8080/static/amap_html/amap_profile.html',//给iframe_src做师傅分布图的链接
              iframe_src_link:`${dd_amap_url1}/static/amap_html/amap_profile.html`,//给iframe_src做师傅分布图的链接
          }
      },
      created(){
          let _this=this;
