+<template>
  <el-form ref="AccountFrom" :model="account" :rules="rules" label-position="left" label-width="0px"
    ...
    <el-form-item prop="username" style="text-align: center">
      <span class="fon"></span>
      <el-input type="text" v-model.trim="account.username" auto-complete="off" placeholder="请输入账号"></el-input>
    </el-form-item>
    <el-form-item prop="pwd" style="text-align: center">
      <span class="fon"></span>
      <el-input type="password" v-model.trim="account.pwd" auto-complete="off" placeholder="请输入密码"></el-input>
    </el-form-item>
