    ...
    <div >                                 <!--完成工单-->
      ...
      <div v-show="orderDetailed.isShow"  class="container">
        ...
        <div class="selector_list">
          ...
          <!--{{item.name}} :-->
          <!--<el-select-->
          <!--v-model.trim="item.SourceTypeValue" placeholder="请选择" @change="selector(item,item.SourceType,item.SourceTypeValue)">-->
          <!--<el-option-->
          ...
          <div class="list">
            工单类型 :
            <el-select v-model.trim="orderTypeOne" placeholder="请选择" @change="orderTypeOneClick(orderTypeOne)">
              <el-option
          ...
          <div class="list">
            工单状态 :
            <el-select v-model.trim="orderZhuangtaiName" placeholder="请选择" @change="orderZhuangtaiOneClick(orderZhuangtaiName)">
              <el-option
                v-for="(item,index) in orderZhuangtai"
                :key="index"
                :label="item.name"
                :value="item.name">
              </el-option>
          ...
          <table id="table" cellSpacing="0px" cellpadding="0">
            ...
            <tr v-for="(item,index) in tableListData.orders">
              ...
              <td class="icon">
                ...
                <span @click="reminder(item)" style="height: 18px;width: 18px;display: inline-block">
  ...
  export default {
    ...
    data() {
      return {
        ...
        orderTypeOne:"", //工单类型
        orderZhuangtaiName:"",
        orderZhuangtaiOne:"12,15,17,18",//工单状态
        orderZhuangtai:[
          {
            id:"12,15,17,18",
            name:"--请选择--"
...
//            添加师傅详情结束
    ...
    methods: {
      ...
      orderZhuangtaiOneClick(item){//工单状态
         this.orderZhuangtai.forEach((v,i)=>{
           if(item === v.name){
             this.orderZhuangtaiOne =v.id;
           }
         })
        console.log(this.orderZhuangtaiOne)
      },
