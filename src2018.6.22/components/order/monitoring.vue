    ...
    <div v-show="orderDetailed.isShow" class="container">
      ...
      <div class="selector_list">
        ...
        <div class="list">
          ...
          <el-input
            placeholder="请输入内容"
            v-model.trim="inputParams.phoneName">
          </el-input>
        </div>
        <div class="list">
          师傅手机号:
        ...
        <div class="list">
          渠道质保 :
          <el-select v-model.trim="quality" placeholder="请选择" @change="qualityClick(quality)">
            <el-option
        ...
        <!--<div class="list">-->
          ...
          <!--<el-input-->
            <!--placeholder="请输入内容"-->
            <!--v-model.trim="inputParams.masterId">-->
          <!--</el-input>-->
        <!--</div>-->
        ...
        <div class="list">
          工单来源 :
          <el-select v-model.trim="orderLabe3" placeholder="请选择" @change="selectorThree(orderLabe3)">
            <el-option
        ...
        <div class="selector_listRight">
          <p>收起所有筛选   <img :src="jiantou" @click="jiantouClick"></p>
        </div>
      </div>
      ...
      <!--查询按钮-->
      <div class="footerBnt" v-show="seachShow">
    ...
    methods: {
      ...
      paramsData(){
        ...
        return{
          ...
          //"masterId":this.inputParams.masterId,                //师傅编号
          'linkmanPhoneNum':this.inputParams.orderTel,           //联系人手机号
          'linkmanName':this.inputParams.phoneName,               //联系人姓名
          'masterPhoneNum':this.inputParams.masterPhone,          //师傅手机号
          'masterName':this.inputParams.masterName,               //师傅姓名
          'userPhoneNum':this.inputParams.userPhoneNum,                       //绑定手机号
