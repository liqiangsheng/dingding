<template>
    <div id="app">
      <section class="container">
          ...
          <span class="price_sum">{{!!creditCardMessage.balance?creditCardMessage.balance.toFixed(2):0.00}}</span>
<!--提现 start -->
 ...
 <!--提现 end -->
        <br>
          <span class="list_name">{{rechargeText}}金额</span> <el-input style="width:300px;"   v-model="money" type="number" :placeholder="'请输入'+rechargeText+'金额'"></el-input>
      </section>
