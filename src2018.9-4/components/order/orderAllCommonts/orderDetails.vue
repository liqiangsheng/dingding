    ...
    <div class="headerBtn bottom">
      ...
      <div>
        <p class="left_info_edit cursor"
           v-if="(dataObj.orderStatus=='05' || dataObj.orderStatus=='06' || dataObj.orderStatus=='08') && repair_work_btn"
        ...
        <div v-if="telescopic">
          ...
          <table class="tableProduct" style="border-top: 1px solid #C0CCDA" v-for="(item,index) in productList.tableListData" :key="index"
            ...
            <tr>
              ...
              <td>￥{{item.price2 | placeholder_one}}</td>
              ...
              <td>
               <span
                 v-if="item.warrantyDatetime>Date.parse(new Date())||item.warrantyDatetime"
          ...
          <table class="tablePrice" style="border-top: 1px solid #C0CCDA">
            <tr>
              <td>上门费小计<span>￥{{orderData.price1|twoNum}}</span></td>
              <td>高空费小计<span>￥{{orderData.price4|twoNum}}</span></td>
              <td>服务费小计<span>￥{{orderData.price2Original |twoNum}}</span></td>
              <td colspan="2">配件费小计<span style="left: 89%">￥{{orderData.price3|twoNum}}</span></td>
