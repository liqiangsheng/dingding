        ...
        <div class="left_info">
          ...
          <ul class="add_master">
            ...
            <li style="width: 100%">
              ...
              <ul v-if="!!isAdd.id&&!isEdit&&editData.licenseImg&&editData.identityCardImgFront" class="idPhotoes">
                <li>
            ...
            <li v-if="!isAdd.id||isAdd.id&&isEdit" style="margin-right: 0;margin-top: 24px">
              <ul class="files">
...
//        if( prams.type==="3"&&!prams.siteId)return this.$queryFun.successAlert.call(this,'请选择所属网点');
      ...
      edit(){
        this.isEdit=true;
        console.log(this.editData.masterInfo.idPhotos)
      },
      skillIdsOne1(v){
        this.skillIdsOne2 =v;
      },
