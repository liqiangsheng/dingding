  ...
  <div id="app">
    ...
    <div v-show="orderDetailed.isShow" class="container">
      ...
      <div class="selector_list">
        ...
        <div class="list">
          工单类型 :
          <el-select v-model="orderLabe2" placeholder="请选择" @change="selectorTwo(orderLabe2)">
            <el-option
        ...
        <div class="list">
          工单来源 :
          <el-select v-model="orderLabe3" placeholder="请选择" @change="selectorThree(orderLabe3)">
            <el-option
