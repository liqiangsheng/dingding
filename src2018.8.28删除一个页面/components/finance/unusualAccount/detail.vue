      ...
      <div class="selector_list">
        <div class="list">
          ...
          <el-input
            ...
            v-model.trim="selectorBehindObj.objNumber">
          </el-input>
        </div>
        <div class="list">
          账户编号 :
          <el-input
            placeholder="请填写关键字查询"
            v-model.trim="selectorBehindObj.accountNumber">
          </el-input>
        </div>
        <div class="list">
          金额大于 :
          <el-input
            placeholder="请填写关键字查询"
            type="number"
            v-model.trim="selectorBehindObj.number">
          </el-input>
        </div>
        <div class="list">
          记账时间 :
          <DatePicker v-model.trim="selectorBehindObj.time" type="datetime" format="yyyy-MM-dd HH:mm"
                      placeholder="选择日期和时间（不含秒）" style="width: 200px"></DatePicker>
        </div>
