  ...
  <div id="app" v-cloak @touchmove.prevent>
    ...
    <div class="tableList">
      ...
      <div class="productInfo">
        ...
        <div v-if="telescopic">
          <!--<table class="tableProduct"  style="margin-bottom: 0;">-->
          <!--<thead>-->
          <!--<tr>-->
          ...
          <!--</thead>-->
          <!--</table>-->
          <table class="tableProduct" style="margin: 0;" v-for="(item,index) in productList.tableListData" :key="index"
                 :class="{active:item.status == 1,otherTable:index !==0,lastTable:index==(productList.tableListData.length-1)}">
            <thead v-if="index ===0 ||!productList.tableListData.length">
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <!--<i class="remaktip" @mouseenter="enterto" @mouseleave="leaveto">
                  <div class="trigont" v-if="tip&&item.remarks"><i></i>工程师备注:{{item.remarks}}</div>
                </i>-->
              ...
              <td>
               <span
                 v-if="item.warrantyDatetime>Date.parse(new Date())"
            ...
            <tr style="height: 30px;background:rgba(240,240,240,1);" v-if="item.mountings.length">
              <td>序号</td>
            ...
            <tr v-for="(todo,index) in item.mountings"
              ...
              <td colspan="3">￥{{todo.serviceMountingsPrice}}</td>
              <!--<td colspan="14">
               <span>
                 <font style="color: rgba(94, 109, 130, 1);display: inline-block;width: 60px">
                   配件{{index + 1}}:</font> &nbsp {{todo.serviceMountingsName}}*{{todo.serviceMountingsCount}}
               </span>
                <span>￥{{todo.serviceMountingsPrice}}</span>
              </td>-->
            </tr>
          ...
          <table class="tablePrice">
            ...
            <tr>
              ...
              <td>折扣金额<span>￥{{orderData.price2Original-orderData.price2|twoNum}}</span></td>
              <td>积分抵扣<span>￥0.00</span></td>
              <td colspan="2">用券折扣<span style="left: 89%">￥{{orderData.discountPrice|twoNum}}</span></td>
              <td>优惠合计<span>￥{{orderData.price2Original - orderData.price2 + orderData.discountPrice|twoNum}}</span></td>
            </tr>
            <tr>
          ...
          <div v-if="telescopic1">
            ...
            <table :class="{edit:this.isEdit()}">
              ...
              <tr>
                ...
                <td>渠道质保</td>
                <td :class="{Deposit:isChannel&&isEdit()}">
...
<script>
  ...
  export default {
    ...
    props: ["orderDetailed", "quiry", 'drawbackIsShow', 'addRemarksIsShow', 'replaceMaster', 'complainFn',
      ...
      'unusual', 'masterImposeIsShow', 'changeTimeIsShows', 'reminder', 'yuYueTimeIsShow'
    ],
    components: {
      alertInfo,
      changTime,
      ...
      > .productInfo {
        ...
        .tableProduct {
          ...
          tr {
            ...
            td:nth-of-type(3), td:nth-of-type(7), td:nth-of-type(10), td:nth-of-type(11), td:nth-of-type(12) {
              width: 4.8%;
            }
            td:nth-of-type(4), td:nth-of-type(5), td:nth-of-type(6), td:nth-of-type(8), td:nth-of-type(9) {
              width: 7%;
            }
            td:nth-of-type(13) {
              width: 12%;
