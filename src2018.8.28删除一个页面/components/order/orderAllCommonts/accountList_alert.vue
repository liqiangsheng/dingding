          ...
          <ul>
            ...
            <li>手机号:
              ...
              <span v-else>
                  <el-input
                    placeholder="请填写内容"
                    v-model.trim="dataObj.userTel">
                 </el-input>
              </span>
            </li>
            <li>工程师类别:{{dataObj.masterType}}</li>
            <li>工程师编号:{{dataObj.masterNumber}}</li>
            ...
            <li>
              ...
              <span v-else>
                <el-select
                  v-model.trim="dataObj.cityPositionData.SourceTypeValue" placeholder="请选择"
            ...
            <li>服务工种:
              ...
              <span v-else>
                <el-select
                  v-model.trim="dataObj.serveTypePositionData.SourceTypeValue" placeholder="请选择"
            ...
            <li>
              ...
              <span v-else>
                <el-select
                  v-model.trim="dataObj.workStatu.SourceTypeValue" placeholder="请选择"
            ...
            <li>
              ...
              <span v-else>
                <el-select
                  v-model.trim="dataObj.remindedDrops.SourceTypeValue" placeholder="请选择"
