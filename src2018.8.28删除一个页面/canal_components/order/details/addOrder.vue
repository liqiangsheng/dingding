                ...
                <ul>
                  <li style="margin-top:0;">
                    ...
                    <el-select style="width:217px;"
                               v-model.trim="officialPartnerSubsetId.SourceTypeValue" placeholder="请选择"
                               @change="selector(officialPartnerSubsetId,officialPartnerSubsetId.SourceType,officialPartnerSubsetId.SourceTypeValue)">
                      <el-option
                  ...
                  <li>
                    ...
                    {{showAddress}}
                    <el-input
                      :placeholder="showAddress?'楼号／门牌号':'请填写地址'"
                      v-model.trim="addOrder.linkmanAddress">
                    </el-input>
                  </li>
                  <li>
                    <span class="list_name">  预约时间 : </span>
                    <DatePicker v-model.trim="addOrder.appointmentDatetime"
