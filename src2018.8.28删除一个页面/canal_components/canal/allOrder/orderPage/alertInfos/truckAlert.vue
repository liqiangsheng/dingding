             ...
             <div class="trackAlertLeft">
                   <ul>
                     <li v-for="(item,index) in userInformation">
                       <img src="/static/images/wancheng.png">
                       <div><p>{{item.operateAction}}</p><br><p class="p1">{{item.operateTime|moment('YYYY-MM-DD HH:mm:ss')}}</p><br><p class="p2" v-show="item.operateRemark">备注:{{item.operateRemark}}</p></div>
                     </li>
              ...
              <div class="trackAlertRight">
                      ...
                      <div class="trackAlertBottom">
                            <div class="box"><span></span><span>工程师定位跟踪</span></div>
                            <div class="mapbox">
