<template>
  <div class="addMasterList">
    <C_header title="服务区域" right_number="4" :editResetWorker='resetWorker' left_number='2'></C_header>
...
//        console.log(this.$route.query.areaData, '686868')
//        this.areaList = this.$route.query.areaData;
//        this.workerList = this.$route.query.workerData;

        console.log(this.$route.query.cityId, '8888', this.areaList)
        if (!this.areaList) {
...
//        this.$router.push({path: `/editMasterDetails`, query: {workerData: this.workerList, areaData: this.areaList}})
      }
    }
