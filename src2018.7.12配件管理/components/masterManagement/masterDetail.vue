  ...
  <div id="masterDetail">
    ...
    <div class="masterDetailContent">
      <ul class="personal_information">
        ...
        <li id="emergencyContact"><span>紧急联系人</span><span>{{masterDetailObj.emergencyContact}}</span><span style="margin-left: 0.2rem">{{masterDetailObj.emergencyPhoneNum}}</span></li>
    ...
    <div class="footer">
      ...
      <p><span>认证时间:</span><span>{{masterDetailObj.certificateTime|moment('YYYY-MM-DD HH:mm:ss')||"无"}}</span></p>
    </div>
...
//          this.areas +=" "+v.label+",";
          a.push(v.label);
          a.sort((a,b)=>a.localeCompare(b,"zh"));
          this.areas = a.join("，")
        })
...
//          this.skills +=" "+v.label+",";
          b.push(v.label);
          b.sort((a,b)=>a.localeCompare(b,"zh"));
          this.skills =  b.join("，")
        })
