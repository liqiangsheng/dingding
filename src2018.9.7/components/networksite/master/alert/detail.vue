      ...
      <div class="content">
        <div class="left_info">
          ...
          <ul>
            ...
            <li>工程师类别:{{dataObj.type|mastertype}}</li>
            <li>工程师编号:{{dataObj.id}}</li>
            <!--可编辑-->
            <li>
              服务城市: {{dataObj.city}}
            </li> <!--可编辑-->
    ...
    created(){
      ...
      this.$http.get(url).then(res=>{
        ...
        this.city.SourceTypeValue = this.dataObj.city;
         var images = data.result.masterInfo.idPhotos? data.result.masterInfo.idPhotos.split(",") : [];
//        var images = data.result.masterInfo.idPhotos;
