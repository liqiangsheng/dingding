    ...
    <div class="container">
      <div class="selector_list">
        <div class="list">
          ...
          <el-input
            placeholder="请填写用户名"
            v-model.trim="selectorBehindObj.userName">
          </el-input>
        </div>
      ...
      <div class="dable_lsit">
        ...
        <table cellSpacing="0px" cellpadding="0">
          ...
          <tr v-for="(item,index) in tableListData.serviceSales">
            ...
            <td>
              <span v-if="!!item.updateTime">{{item.updateTime|moment('YYYY-MM-DD HH:mm:ss')}}</span>
              <span v-else>无</span>
            </td>
            <td>
        ...
        this.$http.get(url,params).then(r=>{
          ...
          if(data.code==="0000"){
            this.tableListData = data.result;
              this.tableListData.serviceSales.forEach((obj,i)=>{
                   if(obj['updateTime'] ==undefined){
                     this.$set(obj,'updateTime',"");
                   }
              });
            console.log(this.tableListData.serviceSales,'时间')
