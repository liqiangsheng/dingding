      ...
      <div class="essentialInfo">
        <div class="left">
          ...
          <table :class="{edit:this.isEdit()}">
            <tr>
              <td class="fontWidth">工单号</td><td  @click="showorder(orderData.mainOrderId)"><span style="cursor: pointer" class="orderLine">{{orderData.mainOrderId}}</span></td>
              <td class="fontWidth">状态</td><td><span style="color:rgba(230,88,49,1);">{{orderData.state | orderStateShow|placeholder}}</span></td>
            </tr>
            <tr>
              <td class="fontWidth">返修工单号</td><td> {{orderData.id}}</td>
