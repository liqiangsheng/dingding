  ...
  <div id="app">
    <el-dialog style="z-index:999999"  :visible.sync="isDrawback.isShow" size="tiny">
      ...
      <ul class="alert_forbidden_text">
        ...
        <li class="bor">
          <span>应付总服务费</span>{{isDrawback.data.price2}}
        </li>
        <li class="bor">
          <span>已返现金额</span>{{isDrawback.data.cashbackAmount}}
        </li>
        <li class="bor">
        ...
        <li class="borone">
          ...
          <el-input style="width:auto"
                    ...
                    type="number"
                    placeholder="请填写返现金额"
                    v-model.trim="objData.refund">
          </el-input>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;最高返现金额: {{(isDrawback.data.totalServiceChargeTotal)-(isDrawback.data.cashbackAmount)}}元
        </li>
      ...
      备注:
      <textarea class="alert_forbidden_area" v-model.trim="objData.textareaContent">
        </textarea>
...
//      },
    ...
    created() {
      console.log(this.isDrawback,"ashjfdaskk")
    },
  }
</script>
<style>
