...
Vue.prototype.$wechatProductAssortment = common.wechatProductAssortment
Vue.prototype.$role_api_host = common.role_api_host
...
if(JSON.parse(localStorage.getItem("enrolleeinfo"))){
  Vue.prototype.$http = axios.create({
        headers: { 'content-type': 'application/json',"token": JSON.parse(localStorage.getItem("enrolleeinfo")).token}
    });
} else {
    Vue.prototype.$http = axios.create({
