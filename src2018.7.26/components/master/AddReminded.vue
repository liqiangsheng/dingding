        ...
        <div class="right_info">
          ...
          <ul style="position: relative">
            <li v-for="(item,index) in RemindedList[0].SourceType">
              ...
              <img src="/static/images/add.png" @click="addOne(item,index)" @blur="changeCount(item.shareValue)">
...
//        this.edit.item.operateTime = this.$moment(this.edit.item.operateTime).format('YYYY-MM-DD HH:mm:ss');
        ...
        console.log(this.edit.item,"sfdsfs")
...
//            上门费
              this.RemindedList[0].SourceType[0].danwei.forEach((v,i)=>{
                if(v.danweiid === res.data.result[0].shareTypeKey){
                  this.RemindedList[0].SourceType[0].danweiStr = v.value;
                }
              })
               this.RemindedList[0].SourceType[0].shareTypeKey = res.data.result[0].shareTypeKey;
               this.RemindedList[0].SourceType[0].shareValue = res.data.result[0].shareValue+"";
//               服务费
                this.RemindedList[0].SourceType[1].danwei.forEach((v,i)=>{
                  if(v.danweiid === res.data.result[1].shareTypeKey){
                    this.RemindedList[0].SourceType[1].danweiStr = v.value;
                  }
                })
                this.RemindedList[0].SourceType[1].shareTypeKey = res.data.result[1].shareTypeKey;
                this.RemindedList[0].SourceType[1].shareValue = res.data.result[1].shareValue+"";
//                配件费
                this.RemindedList[0].SourceType[2].danwei.forEach((v,i)=>{
                  if(v.danweiid === res.data.result[2].shareTypeKey){
                    this.RemindedList[0].SourceType[2].danweiStr = v.value;
                  }
                })
                this.RemindedList[0].SourceType[2].shareTypeKey = res.data.result[2].shareTypeKey;
                this.RemindedList[0].SourceType[2].shareValue = res.data.result[2].shareValue+"";
//                高空费
                this.RemindedList[0].SourceType[3].danwei.forEach((v,i)=>{
                  if(v.danweiid === res.data.result[3].shareTypeKey){
                    this.RemindedList[0].SourceType[3].danweiStr = v.value;
                  }
                })
                this.RemindedList[0].SourceType[3].shareTypeKey = res.data.result[3].shareTypeKey;
                this.RemindedList[0].SourceType[3].shareValue = res.data.result[3].shareValue+"";
    ...
    methods: {
      Preservation(){ //保存
            if(!this.edit.item){
              ...
              this.selectorBehindObj.configIdsJson =JSON.stringify(this.RemindedList[0].SourceType);
              let url = this.$apidomain +  "/mastercommissionconfig/saveCommissionConfig";
