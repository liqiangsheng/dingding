      ...
      <div class="content">
        <div class="left_info">
          ...
          <ul>
            ...
            <li>服务地址:
              ...
              <div style="display: inline-block;width:80%" v-if="this.isEdit()">
                ...
                <!--<div class="list_name">-->
                  <!--小区/大厦-->
                <!--</div> :-->
                <el-input class="iconfo_city"  v-if="!isShowCity" :disabled="isShowCity" placeholder="小区/大厦"  style="width:70%;" v-model="addressData.value"  @blur="getAddress()"></el-input>
                &nbsp;
                &nbsp;
            ...
            <li>
              已收定金 : <span v-if="!isEdit()">{{orderData.payedPrice||0}}</span>
              <el-input v-if="editPayedPrice&&isEdit()" v-model="orderData.payedPrice" min="0" type="number" ></el-input>
            </li>
            ...
            <li>渠道质保:
              ...
              <span v-if="this.isEdit()&&isChannel">
                  <!--<el-input-->
                    <!--placeholder="请输入内容"-->
                    <!--v-model="orderData.contactsName">-->
                 <!--</el-input>-->

                 <el-select v-model="dataObj.channelWarranty" clearable placeholder="请选择">
                  <el-option
...
//            this.isNewservice.data1=data.result.coreMainOrderServices;
            ...
            console.log(this.orderData.payedPrice);
//            console.log(res.officialPartnerSubsetName,'工单渠道',res.officialPartnerName)
...
//           console.log("子渠道:"+res.officialPartnerSubsetName,'主渠道:'+res.officialPartnerName);
           ...
           // this.dataObj.officialPartnerSubsetName=res.officialPartnerSubsetName&&res.officialPartnerName?res.officialPartnerSubsetName+'-'+res.officialPartnerName:"";
//            this.dataObj.officialPartnerSubsetName=res.officialPartnerSubsetName+'-'+res.officialPartnerName;
...
//        console.log(this.dataObj.channelWarranty,'质保,,,')
        ...
        console.log(Object.assign(o, this.addressCode(this.addressData.addressComponent)));
