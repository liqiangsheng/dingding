        ...
        <table cellSpacing="0px" cellpadding="0">
          ...
          <tr v-for="(item,index) in tableListData.masterCommissionConfigs">
            ...
            <td>
              ...
              <span @click="del(item,index)" style="display:inline-block;margin-right:10px;cursor:pointer;font-size:14px;font-family:PingFangSC-Regular;color:rgba(230,88,49,1);">删除</span>
              <span @click="addEdit(item,false)" style="margin-left:10px;cursor:pointer;font-size:14px;font-family:PingFangSC-Regular;color:rgba(35,161,254,1);">编辑</span>
            </td>
          </tr>
          </tbody>
        </table>
...
<script>
  import alertInfo from "./addReminded.vue";
//  import alertInfo from "./Reminded_alertONE.vue";
  export default {
    components:{
      alertInfo,
    },
