<template>
  <el-row class="warp">
    <p class="title">欢迎您来到叮叮快修管理后台 !</p>
    <el-col :span="24" class="warp-main" style="transform:translateY(50%)">
...
//        document.getElementById("show").innerHTML = year+"年"+month+"月"+date+"日"+week+hour+":"+minutes+":"+seconds;
        this.currentDate = year+"年"+month+"月"+date+"日"+week+hour+":"+minutes+":"+seconds;
      }
    },
    created(){
      this.run()
