  ...
  <div id="app">
    ...
    <div v-show="orderDetailed.isShow" class="container">
      ...
      <div class="footerBnt">
        ...
        <el-button style="width:100px;float: right;margin-right: 100px;height: 36px" @click="batchOrder(tableList)" size="large" v-show="$isButtonObj('bn-order-all-batch')">批量派单</el-button>
