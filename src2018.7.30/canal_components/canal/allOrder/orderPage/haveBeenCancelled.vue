<template>
  <div class="haveBeenCancelled">
    <div style="width: 100%;background: #ffffff">
      <div class="center">
        <div class="centerDate">
          <ul>
            <li><span style="display: inline-block;transform: translateY(-10px)">预约时间:　</span>
...
//        this.$store.commit("detailAlterId",vItem1.id)
      ...
      paramsData(){  //传数据给后台
        return{params:{
          ...
          "appointmentDatetimeStartStr":this.statisticsDateStartStr, //开始时间
          "appointmentDatetimeEndStr":this.statisticsDateEndStr,//结束时间
          "state":"04,05,08", //状态
