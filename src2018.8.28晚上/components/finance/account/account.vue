<template>
  <div id="app">
    <div class="container" v-if="!isDatail.isShow" style="width: 101%">
    ...
    data() {
      return {
        ...
        sortData: [
          {
            index:3,
            sortAscendingValues:[" user_name asc "],  //升序
            gradeDownValues:[" user_name desc "],     //降序
          },  {
            index:4,
...
//      <!--分页查询数据对象功能组合start-->
      ...
      //重置查询条件
      reset(){
        this.selectorBehindObj.id = "";
        this.selectorBehindObj.userRole = "";
