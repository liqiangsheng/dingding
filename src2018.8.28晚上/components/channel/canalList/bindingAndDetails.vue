    ...
    <div class="creditIsRunningLow_box ">
      ...
      <div class="content">
        <ul>
          ...
          <li>
            <span class="list_name"> 工程师类型</span>
            <el-select
      ...
      <div v-else class="subChanel">
        <table>
          ...
          <tr>
            <td>绑定工程师</td><td>{{subDetails.masterName}}</td>
          </tr>
        </table>
  ...
  export default {
    ...
    data() {
      return {
        ...
        isSiteShow:false,
        theadList:['选择','工程师编号','工程师姓名','工程师手机号','工程师类别','所属网点'],
        listData:[],
        flag:'',
        bindingData:{
          id:'',
...
//        }
      ...
      submit(){
        console.log(this.bindingData,'渠道Id')
       let url = this.$apidomain+'/officialPartnerSubsetInfo/bindMaster';
       if(this.bindingData.masterId == ""){
         this.$queryFun.successAlert.call(this,'请选择要绑定的工程师')
         return;
       }
