...
import alertTable from "./alert_components"
  ...
  props:["isSendOrders","quiry"],
    ...
    created(){
      ...
      this.data.appointmentDatetime=this.isSendOrders.appointmentDatetime
    },
    methods: {
      enter(data){
        let o = {};
        o.type = "3";
        o.keywords="";
        o.dateStr = this.$moment(this.isSendOrders.appointmentDatetime).format("YYYY-MM-DD HH:mm:ss");
