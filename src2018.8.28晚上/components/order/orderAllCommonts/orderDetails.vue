    ...
    <div class="tableList">
      ...
      <div class="productInfo">
        ...
        <div v-if="telescopic">
          ...
          <table class="tableProduct" style="margin-bottom: 41px;border-top: 1px solid #C0CCDA" v-for="(item,index) in productList.tableListData" :key="index"
            ...
            <tr style="height: 30px;background:rgba(240,240,240,1);color:rgba(94,109,130,1);" v-if="item.mountings.length">
              <td>序号</td>
