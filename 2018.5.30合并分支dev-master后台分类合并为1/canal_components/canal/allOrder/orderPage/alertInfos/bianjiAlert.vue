  ...
  <div>
      ...
      <div class="addAlert_box">
          ...
          <ul class="list" id="addAlertList">
              <li>分类<span>*</span>
                <el-select v-model="bianjiData.fenlei" placeholder="请选择" style="width: 80%" @change="yijifenlei2">
                  <el-option
  ...
  export default {
    ...
    methods: {
      ...
      addProduct(){ //添加
        ...
        this.objData.yijiName = this.bianjiData.yijiName;
    ...
    created(){
      this.fenleiOptions = this.bianjiData;
      console.log(this.bianjiData.numData)
      console.log(this.bianjiData.fenlei)
