...
//        let ControllerUrl = `${this.$apidomain}/officialProductLabelController/all?serviceId=${id}`;
      ...
      add(){//添加
        ...
        this.$emit("flaga",1);
        let urlThree=this.$common.apidomain+"/articleinfo/findChannelListServiceInfo?labelId="+this.addData.serviceId +"&areaId="+this.$store.state.cityIdid1+"&relevanceKey="+this.QuDaoId;
