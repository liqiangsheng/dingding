        ...
        <div class="dable_lsit">
          ...
          <table id="table" cellSpacing="0px" cellpadding="0">
            ...
            <tr v-for="(item,index) in tableListData.orders">
              ...
              <!--工单号-->
              <td @click="orderDetails(item.id)" id="orderId" style="word-break: break-all;">
              ...
              <td class="icon" id="iconS">
                <div v-if="item.state == '15'||item.state == '17'||item.state == '18'">
        ...
        optionList: [       //下拉列表数据
          {
            ...
            key: "orderStatus",
            SourceTypeValue: '', //选中后的
            SourceType:[{value:"已完成",id:"12"},{value:"部分退款",id:"15"},{value:"已清算",id:"17"},{value:"已结算",id:"18"}]
          }
        ],
        stateOne:"12,15,17,18",
        selectorBehindObj: {},
        theadsName: [
          '序号',
          '工单号',
...
//            console.log(this.selone)
      ...
      paramsData(){
        ...
        return{params:{
          ...
          "state":this.stateOne, //"state": "12,15,17,18",
          // "isComplaint":"1",
      ...
      getTableList(params){
        ...
        this.$http.get(url,params).then(r=>{
          ...
          if(data.code==='0000'){
            ...
            console.log(this.tableListData,'数据')
