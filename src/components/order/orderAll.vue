      ...
      <!--table表格-->
        ...
        <!--<table  cellSpacing="0px" cellpadding="0">-->
          ...
          <tr v-for="(item,index) in tableList">
            ...
            <!--工单号-->
            <keep-alive>
            <td  @click="orderDetails(item,item.id,index)" id="orderId" :class="{activeOrder:item.styleShow==true}">
            ...
            <td class="icon" id="iconS">
              ...
              <div v-if="item.state == '02'">
                ...
                <!--<Tooltip content="工单详情" placement="top-end" v-show="$isButtonObj('bn-order-all-details')">-->
                  <!--<span class="iconStyle"  @click="orderDetails(item,item.id)">详情</span>-->
                <!--</Tooltip>-->
                <!--详情-->
              </div>
              <!--------------------------------------------------------------------->
              ...
              <div v-if="item.state == '12'||item.state == '19'">
                ...
                <ul class="iconShow" v-show="item.iconShow" @mouseleave="outHide(item,index)">
                  ...
                  <li>
                    <!--<Tooltip content="工单详情" placement="top-end" v-show="$isButtonObj('bn-order-all-details')">-->
                      <!--<span  @click="orderDetails(item,item.id)">工单详情</span>-->
                    <!--</Tooltip>-->
                  </li>
                  <li>
