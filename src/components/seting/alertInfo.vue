  ...
  <div id="app">
        ...
        <div class="left_info">
          <ul>
            ...
            <li>
              ...
              <el-select
                style="width:175px"
                v-model.trim="level.SourceTypeValue" placeholder="请选择"
    ...
    <el-dialog ref="eldialog" style="z-index:999999;"  :visible.sync="dialogTableVisible" size="tiny">
      <ul class="alert_forbidden_text">
        <li>
          <span>请填写密码 :</span>
          <el-input style="width:100%;" v-model.trim="password" placeholder="请确认密码" type="password"></el-input>
